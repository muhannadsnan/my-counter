...
/*
 CanvasJS HTML5 & JavaScript Charts - v3.0.5 Beta 1 - https://canvasjs.com/ 
 Copyright 2020 fenopix
...
"UTC:"===N.slice(0,4)&&(N=N.slice(4),J=!0);L=J?"getUTC":"get";var V=F[L+"Date"](),M=F[L+"Day"](),W=F[L+"Month"](),a=F[L+"FullYear"](),d=F[L+"Hours"](),c=F[L+"Minutes"](),b=F[L+"Seconds"](),e=F[L+"Milliseconds"](),f=J?0:F.getTimezoneOffset();return L=N.replace(k,function(n){switch(n){case "D":return V;case "DD":return X(V,2);case "DDD":return P[M];case "DDDD":return I[M];case "M":return W+1;case "MM":return X(W+1,2);case "MMM":return R[W];case "MMMM":return Q[W];case "Y":return parseInt(String(a).slice(-2));
...
",",E="";l=String(l);var E=1,F=v="",N=-1,L=[],I=[],Q=0,J=0,P=0,R=!1,V=0,F=l.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);l=null;for(var M=0;F&&M<F.length;M++)if(l=F[M],"."===l&&0>N)N=M;else{if("%"===l)E*=100;else if("\u2030"===l){E*=1E3;continue}else if(","===l[0]&&"."===l[l.length-1]){E/=Math.pow(1E3,l.length-1);N=M+l.length-1;continue}else"E"!==l[0]&&"e"!==l[0]||"0"!==l[l.length-1]||(R=!0);0>N?(L.push(l),"#"===l||"0"===l?Q++:","===l&&P++):(I.push(l),"#"!==l&&"0"!==l||J++)}R&&(l=Math.floor(k),
F=-Math.floor(Math.log(k)/Math.LN10+1),V=0===k?0:0===l?-(Q+F):String(l).length-Q,E/=Math.pow(10,V));0>N&&(N=M);E=(k*E).toFixed(J);l=E.split(".");E=(l[0]+"").split("");k=(l[1]+"").split("");E&&"0"===E[0]&&E.shift();for(R=F=M=J=N=0;0<L.length;)if(l=L.pop(),"#"===l||"0"===l)if(N++,N===Q){var W=E,E=[];if("0"===l)for(l=Q-J-(W?W.length:0);0<l;)W.unshift("0"),l--;for(;0<W.length;)v=W.pop()+v,R++,0===R%F&&(M===P&&0<W.length)&&(v=w+v)}else 0<E.length?(v=E.pop()+v,J++,R++):"0"===l&&(v="0"+v,J++,R++),0===R%
F&&(M===P&&0<E.length)&&(v=w+v);else"E"!==l[0]&&"e"!==l[0]||"0"!==l[l.length-1]||!/[eE][+-]*[0]+/.test(l)?","===l?(M++,F=R,R=0,0<E.length&&(v=w+v)):v=1<l.length&&('"'===l[0]&&'"'===l[l.length-1]||"'"===l[0]&&"'"===l[l.length-1])?l.slice(1,l.length-1)+v:l+v:(l=0>V?l.replace("+","").replace("-",""):l.replace("-",""),v+=l.replace(/[0]+/,function(a){return X(V,a.length)}));w="";for(L=!1;0<I.length;)l=I.shift(),"#"===l||"0"===l?0<k.length&&0!==Number(k.join(""))?(w+=k.shift(),L=!0):"0"===l&&(w+="0",L=
!0):1<l.length&&('"'===l[0]&&'"'===l[l.length-1]||"'"===l[0]&&"'"===l[l.length-1])?w+=l.slice(1,l.length-1):"E"!==l[0]&&"e"!==l[0]||"0"!==l[l.length-1]||!/[eE][+-]*[0]+/.test(l)?w+=l:(l=0>V?l.replace("+","").replace("-",""):l.replace("-",""),w+=l.replace(/[0]+/,function(a){return X(V,a.length)}));v+=(L?t:"")+w;return s?"-"+v:v},Oa=function(k){var l=0,v=0;k=k||window.event;k.offsetX||0===k.offsetX?(l=k.offsetX,v=k.offsetY):k.layerX||0==k.layerX?(l=k.layerX,v=k.layerY):(l=k.pageX-k.target.offsetLeft,
...
Xa(this.fontFamily,this.fontSize,this.fontWeight);if(null===this.maxWidth)throw"Please set maxWidth and height for TextBlock";this._wrapText(this.ctx);this._isDirty=!1;return{width:this.width,height:this.height}};ja.prototype._getLineWithWidth=function(k,l,s){k=String(k);if(!k)return{text:"",width:0};var t=s=0,w=k.length-1,F=Infinity;for(this.ctx.font=this._getFontString();t<=w;){var F=Math.floor((t+w)/2),E=k.substr(0,F+1);s=this.ctx.measureText(E).width;if(s<l)t=F+1;else if(s>l)w=F-1;else break}s>
l&&1<E.length&&(E=E.substr(0,E.length-1),s=this.ctx.measureText(E).width);l=!0;if(E.length===k.length||" "===k[E.length])l=!1;l&&(k=E.split(" "),1<k.length&&k.pop(),E=k.join(" "),s=this.ctx.measureText(E).width);return{text:E,width:s}};ja.prototype._wrapText=function(){var k=new String(Ga(String(this.text))),l=[],s=this.ctx.font,t=0,w=0;this.ctx.font=this._getFontString();if(0===this.frontSize)w=t=0;else for(;0<k.length;){var F=this.maxHeight-(this.topPadding+this.bottomPadding),E=this._getLineWithWidth(k,
this.maxWidth-(this.leftPadding+this.rightPadding),!1);E.height=this._lineHeight;l.push(E);var J=w,w=Math.max(w,E.width),t=t+E.height,k=Ga(k.slice(E.text.length,k.length));F&&t>F&&(E=l.pop(),t-=E.height,w=J)}this._wrappedText={lines:l,width:w,height:t};this.width=w+(this.leftPadding+this.rightPadding);this.height=t+(this.topPadding+this.bottomPadding);this.ctx.font=s};ja.prototype._getFontString=function(){var k;k=""+(this.fontStyle?this.fontStyle+" ":"");k+=this.fontWeight?this.fontWeight+" ":"";
k+=this.fontSize?this.fontSize+"px ":"";var l=this.fontFamily?this.fontFamily+"":"";!t&&l&&(l=l.split(",")[0],"'"!==l[0]&&'"'!==l[0]&&(l="'"+l+"'"));return k+=l};oa(Ta,V);oa(ya,V);ya.prototype.setLayout=function(){if(this.text){var k=this.dockInsidePlotArea?this.chart.plotArea:this.chart,l=k.layoutManager.getFreeSpace(),t=l.x1,w=l.y1,F=0,J=0,E=this.chart._menuButton&&this.chart.exportEnabled&&"top"===this.verticalAlign?22:0,N,I;"top"===this.verticalAlign||"bottom"===this.verticalAlign?(null===this.maxWidth&&
(this.maxWidth=l.width-4-E*("center"===this.horizontalAlign?2:1)),J=0.5*l.height-this.margin-2,F=0):"center"===this.verticalAlign&&("left"===this.horizontalAlign||"right"===this.horizontalAlign?(null===this.maxWidth&&(this.maxWidth=l.height-4),J=0.5*l.width-this.margin-2):"center"===this.horizontalAlign&&(null===this.maxWidth&&(this.maxWidth=l.width-4),J=0.5*l.height-4));var L;s(this.padding)||"number"!==typeof this.padding?s(this.padding)||"object"!==typeof this.padding||(L=this.padding.top?this.padding.top:
this.padding.bottom?this.padding.bottom:0,L+=this.padding.bottom?this.padding.bottom:this.padding.top?this.padding.top:0,L*=1.25):L=2.5*this.padding;this.wrap||(J=Math.min(J,Math.max(1.5*this.fontSize,this.fontSize+L)));J=new ja(this.ctx,{fontSize:this.fontSize,fontFamily:this.fontFamily,fontColor:this.fontColor,fontStyle:this.fontStyle,fontWeight:this.fontWeight,horizontalAlign:this.horizontalAlign,verticalAlign:this.verticalAlign,borderColor:this.borderColor,borderThickness:this.borderThickness,
...
t;J.y=w;J.angle=F;J.horizontalAlign=N;this._textBlock=J;k.layoutManager.registerSpace(I,{width:this.width+("left"===I||"right"===I?this.margin+2:0),height:this.height+("top"===I||"bottom"===I?this.margin+2:0)});this.bounds={x1:t,y1:w,x2:t+this.width,y2:w+this.height};this.ctx.textBaseline="top"}};ya.prototype.render=function(){this._textBlock&&this._textBlock.render(!0)};oa(Ia,V);Ia.prototype.setLayout=ya.prototype.setLayout;Ia.prototype.render=ya.prototype.render;Ua.prototype.get=function(k,l){var s=
null;0<this.pool.length?(s=this.pool.pop(),Ma(s,k,l)):s=ta(k,l);return s};Ua.prototype.release=function(k){this.pool.push(k)};oa(Ja,V);var Pa={addTheme:function(k,l){bb[k]=l},addColorSet:function(k,l){za[k]=l},addCultureInfo:function(k,l){Ka[k]=l},formatNumber:function(k,l,s){s=s||"en";if(Ka[s])return ea(k,l||"#,##0.##",new Ja(s));throw"Unknown Culture Name";},formatDate:function(k,l,s){s=s||"en";if(Ka[s])return Aa(k,l||"DD MMM YYYY",new Ja(s));throw"Unknown Culture Name";}};"undefined"!==typeof module&&
...
2+1;var A=(a[n].x-a[f].x)/b;b=(a[n].y-a[f].y)/b;c[c.length]=a[m].x>a[f].x&&0<A||a[m].x<a[f].x&&0>A?{x:a[m].x+A/3,y:a[m].y+b/3}:{x:a[m].x,y:a[m].y+b/9};m=e;f=0===m?0:m-1;n=m===a.length-1?m:m+1;b=Math.abs((a[n].x-a[f].x)/(0===a[m].x-a[f].x?0.01:a[m].x-a[f].x))*(d-1)/2+1;A=(a[n].x-a[f].x)/b;b=(a[n].y-a[f].y)/b;c[c.length]=a[m].x>a[f].x&&0<A||a[m].x<a[f].x&&0>A?{x:a[m].x-A/3,y:a[m].y-b/3}:{x:a[m].x,y:a[m].y-b/9};c[c.length]=a[e]}return c}function w(a,d,c,b,e,f,n,m,A,h){var r=0;h?(n.color=f,m.color=f):
h=1;r=A?Math.abs(e-c):Math.abs(b-d);r=0<n.trimLength?Math.abs(r*n.trimLength/100):Math.abs(r-n.length);A?(c+=r/2,e-=r/2):(d+=r/2,b-=r/2);var r=1===Math.round(n.thickness)%2?0.5:0,q=1===Math.round(m.thickness)%2?0.5:0;a.save();a.globalAlpha=h;a.strokeStyle=m.color||f;a.lineWidth=m.thickness||2;a.setLineDash&&a.setLineDash(N(m.dashType,m.thickness));a.beginPath();A&&0<m.thickness?(a.moveTo(b-n.thickness/2,Math.round((c+e)/2)-q),a.lineTo(d+n.thickness/2,Math.round((c+e)/2)-q)):0<m.thickness&&(a.moveTo(Math.round((d+
b)/2)-q,c+n.thickness/2),a.lineTo(Math.round((d+b)/2)-q,e-n.thickness/2));a.stroke();a.strokeStyle=n.color||f;a.lineWidth=n.thickness||2;a.setLineDash&&a.setLineDash(N(n.dashType,n.thickness));a.beginPath();A&&0<n.thickness?(a.moveTo(b-r,c),a.lineTo(b-r,e),a.moveTo(d+r,c),a.lineTo(d+r,e)):0<n.thickness&&(a.moveTo(d,c+r),a.lineTo(b,c+r),a.moveTo(d,e-r),a.lineTo(b,e-r));a.stroke();a.restore()}function F(a,d){F.base.constructor.call(this,"Legend","legend",d,null,a);this.chart=a;this.canvas=a.canvas;
this.ctx=this.chart.ctx;this.ghostCtx=this.chart._eventManager.ghostCtx;this.items=[];this.optionsName="legend";this.height=this.width=0;this.orientation=null;this.dataSeries=[];this.bounds={x1:null,y1:null,x2:null,y2:null};"undefined"===typeof this.options.fontSize&&(this.fontSize=this.chart.getAutoFontSize(this.fontSize));this.lineHeight=Xa(this.fontFamily,this.fontSize,this.fontWeight);this.horizontalSpacing=this.fontSize}function I(a,d,c,b){I.base.constructor.call(this,"DataSeries","data",d,c,
...
(this.labelFontSize=this.chart.getAutoFontSize(this.labelFontSize));this.type=e;"axisX"!==e||c&&"undefined"!==typeof c.gridThickness||(this.gridThickness=0);this._position=f;this.lineCoordinates={x1:null,y1:null,x2:null,y2:null,width:null};this.labelAngle=(this.labelAngle%360+360)%360;90<this.labelAngle&&270>this.labelAngle?this.labelAngle-=180:270<=this.labelAngle&&360>=this.labelAngle&&(this.labelAngle-=360);this.options.scaleBreaks&&(this.scaleBreaks=new $(this.chart,this.options.scaleBreaks,++this.chart._eventManager.lastObjectId,
this));this.stripLines=[];if(this.options.stripLines&&0<this.options.stripLines.length)for(a=0;a<this.options.stripLines.length;a++)this.stripLines.push(new L(this.chart,this.options.stripLines[a],a,++this.chart._eventManager.lastObjectId,this));this.options.crosshair&&(this.crosshair=new aa(this.chart,this.options.crosshair,this));this._titleTextBlock=null;this.hasOptionChanged("viewportMinimum")&&null===this.viewportMinimum&&(this.options.viewportMinimum=void 0,this.sessionVariables.viewportMinimum=
...
1:0}function L(a,d,c,b,e){L.base.constructor.call(this,"StripLine","stripLines",d,c,e);this.id=b;this.chart=a;this.ctx=this.chart.ctx;this.label=this.label;this.axis=e;this.optionsName="stripLines";this.isOptionsInArray=!0;this._thicknessType="pixel";null!==this.startValue&&null!==this.endValue&&(this.value=e.logarithmic?Math.sqrt((this.startValue.getTime?this.startValue.getTime():this.startValue)*(this.endValue.getTime?this.endValue.getTime():this.endValue)):((this.startValue.getTime?this.startValue.getTime():
this.startValue)+(this.endValue.getTime?this.endValue.getTime():this.endValue))/2,this._thicknessType=null)}function aa(a,d,c){aa.base.constructor.call(this,"Crosshair","crosshair",d,null,c);this.chart=a;this.ctx=this.chart.ctx;this.axis=c;this.optionsName="crosshair";this._thicknessType="pixel"}function X(a,d){X.base.constructor.call(this,"ToolTip","toolTip",d,null,a);this.chart=a;this.canvas=a.canvas;this.ctx=this.chart.ctx;this.currentDataPointIndex=this.currentSeriesIndex=-1;this._prevY=this._prevX=
...
new Ja(this.options.culture);this.updateOption("animationEnabled");this.animationEnabled=this.animationEnabled&&t;this.updateOption("animationDuration");this.updateOption("rangeChanging");this.updateOption("rangeChanged");this.updateOption("exportEnabled");this.updateOption("exportFileName");this.updateOption("zoomType");if(this.options.zoomEnabled||this.panEnabled){if(!this._zoomButton){var d=!1;ua(this._zoomButton=document.createElement("button"));va(this,this._zoomButton,"pan");this._toolBar.appendChild(this._zoomButton);
this._zoomButton.style.borderRight=this.toolbar.borderThickness+"px solid "+this.toolbar.borderColor;P(this._zoomButton,"touchstart",function(a){d=!0},this.allDOMEventHandlers);P(this._zoomButton,"click",function(){a.zoomEnabled?(a.zoomEnabled=!1,a.panEnabled=!0,va(a,a._zoomButton,"zoom")):(a.zoomEnabled=!0,a.panEnabled=!1,va(a,a._zoomButton,"pan"));a.render()},this.allDOMEventHandlers);P(this._zoomButton,"mouseover",function(){d?d=!1:(pa(a,a._zoomButton,{backgroundColor:a.toolbar.backgroundColorOnHover,
...
filter:"invert(0%)"}))},this.allDOMEventHandlers)}this._resetButton||(d=!1,ua(this._resetButton=document.createElement("button")),va(this,this._resetButton,"reset"),this._resetButton.style.borderRight=(this.exportEnabled?this.toolbar.borderThickness:0)+"px solid "+this.toolbar.borderColor,this._toolBar.appendChild(this._resetButton),P(this._resetButton,"touchstart",function(a){d=!0},this.allDOMEventHandlers),P(this._resetButton,"click",function(){a.toolTip.hide();a.toolTip.dispatchEvent("hidden",
...
a.stockChart._rangeEventParameter,a.stockChart))},this.allDOMEventHandlers),P(this._resetButton,"mouseover",function(){d||(pa(a,a._resetButton,{backgroundColor:a.toolbar.backgroundColorOnHover,color:a.toolbar.hoverFfontColorOnHoverontColor,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&pa(a,a._resetButton.childNodes[0],{WebkitFilter:"invert(100%)",filter:"invert(100%)"}))},this.allDOMEventHandlers),P(this._resetButton,"mouseout",function(){d||(pa(a,a._resetButton,
...
!1),La(a._zoomButton,a._resetButton)):(this.zoomEnabled=!0,this.panEnabled=!1))}else this.panEnabled=this.zoomEnabled=!1;gb(this);"none"!==this._toolBar.style.display&&this._zoomButton&&(this.panEnabled?va(a,a._zoomButton,"zoom"):va(a,a._zoomButton,"pan"),a._resetButton.getAttribute("state")!==a._cultureInfo.resetText&&va(a,a._resetButton,"reset"));this.options.toolTip&&this.toolTip.options!==this.options.toolTip&&(this.toolTip.options=this.options.toolTip);for(var c in this.toolTip.options)this.toolTip.options.hasOwnProperty(c)&&
this.toolTip.updateOption(c)};l.prototype._updateSize=function(){var a;a=[this.canvas,this.overlaidCanvas,this._eventManager.ghostCanvas];var d=0,c=0;this.options.width?d=this.width:this.width=d=0<this.container.clientWidth?this.container.clientWidth:this.width;this.options.height?c=this.height:this.height=c=0<this.container.clientHeight?this.container.clientHeight:this.height;if(this.canvas.width!==d*ha||this.canvas.height!==c*ha){for(var b=0;b<a.length;b++)Ma(a[b],d,c);this.bounds={x1:0,y1:0,x2:this.width,
...
this.animatedRender=t&&this.animationEnabled&&0===this.renderCount;this._updateSize();this.clearCanvas();this.ctx.beginPath();this.axisX=[];this.axisX2=[];this.axisY=[];this.axisY2=[];this._indexLabels=[];this._dataInRenderedOrder=[];this._events=[];this._eventManager&&this._eventManager.reset();this.plotInfo={axisPlacement:null,plotTypes:[]};this.layoutManager=new Ea(0,0,this.width,this.height,this.isNavigator?0:2);this.plotArea.layoutManager&&this.plotArea.layoutManager.reset();this.data=[];var a=
0,d=null;if(this.options.data){for(var c=0;c<this.options.data.length;c++)if(a++,!this.options.data[c].type||0<=l._supportedChartTypes.indexOf(this.options.data[c].type)){var b=new I(this,this.options.data[c],a-1,++this._eventManager.lastObjectId);"error"===b.type&&(b.linkedDataSeriesIndex=s(this.options.data[c].linkedDataSeriesIndex)?c-1:this.options.data[c].linkedDataSeriesIndex,0>b.linkedDataSeriesIndex||b.linkedDataSeriesIndex>=this.options.data.length||"number"!==typeof b.linkedDataSeriesIndex||
...
0)+"px solid "+this.toolbar.borderColor):(ua(this._zoomButton,this._resetButton),this._toolBar.style.border=this.toolbar.borderThickness+"px solid transparent",this.options.zoomEnabled&&(this.zoomEnabled=!0,this.panEnabled=!1));fb(this);this._processData();this.options.title&&(this.title=new ya(this,this.options.title),this.title.dockInsidePlotArea?a.push(this.title):this.title.setLayout());this.subtitles=[];if(this.options.subtitles)for(d=0;d<this.options.subtitles.length;d++)c=new Ia(this,this.options.subtitles[d],
...
{chart:r})});else{if(r._breaksCanvas)if(t)r.plotArea.ctx.drawImage(r._breaksCanvas,0,0,this.width,this.height);else for(h=0;h<r._axes.length;h++)r._axes[h].createMask();0<r._indexLabels.length&&r.renderIndexLabels();r.dispatchEvent("dataAnimationIterationEnd",{chart:r});r.dispatchEvent("dataAnimationEnd",{chart:r})}this.attachPlotAreaEventHandlers();this.zoomEnabled||(this.panEnabled||!this._zoomButton||"none"===this._zoomButton.style.display)||ua(this._zoomButton,this._resetButton);this.toolTip._updateToolTip();
this.renderCount++;Ha&&(r=this,setTimeout(function(){var a=document.getElementById("ghostCanvasCopy");a&&(Ma(a,r.width,r.height),a.getContext("2d").drawImage(r._eventManager.ghostCanvas,0,0))},2E3));this._breaksCanvas&&(delete this._breaksCanvas,delete this._breaksCanvasCtx);for(h=0;h<this._axes.length;h++)this._axes[h].maskCanvas&&(delete this._axes[h].maskCanvas,delete this._axes[h].maskCtx)};l.prototype.render=function(a){a&&(this.options=a);this._initialize();this.setLayout();this.renderElements();
...
n[b]?n[b]+=e:(n[b]=e,A=Math.min(e,A)):m[b]?m[b]+=e:(m[b]=e,h=Math.max(e,h)))}}a.axisY.scaleBreaks&&(a.axisY.scaleBreaks.autoCalculate&&1<=a.axisY.scaleBreaks.maxNumberOfAutoBreaks)&&(d.dataPointYPositiveSums?(d.dataPointYPositiveSums.push.apply(d.dataPointYPositiveSums,n),d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums,m)):(d.dataPointYPositiveSums=n,d.dataPointYNegativeSums=m));q.axisX.valueType=q.xValueType=f?"dateTime":"number"}for(p in n)n.hasOwnProperty(p)&&!isNaN(p)&&(a=n[p],a<
...
else{if(!p&&(p=!0,0<q)){q-=2;continue}if(b>l&&!g)g=!0;else if(b>l&&g)continue;r.dataPoints[q].label&&(a.axisX.labels[b]=r.dataPoints[q].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===e?c.viewPortMin===b&&C<b&&(c.viewPortMin=C):(a.yTotals[b]=(a.yTotals[b]?a.yTotals[b]:0)+e,0<=e?n=!0:0>e&&(m=!0),A[b]=A[b]?A[b]+Math.abs(e):Math.abs(e))}}r.axisX.valueType=r.xValueType=f?"dateTime":"number"}a.axisY.logarithmic?(d.max=s(d.viewPortMax)?99*Math.pow(a.axisY.logarithmBase,
...
(h.dataPoints[r].x=r+(a.axisX.logarithmic?1:0));h.dataPoints[r].x.getTime?(m=!0,b=h.dataPoints[r].x.getTime()):b=h.dataPoints[r].x;if((e=h.dataPoints[r].y)&&e.length){f=Math.min.apply(null,e);n=Math.max.apply(null,e);C=!0;for(var x=0;x<e.length;x++)null===e.k&&(C=!1);C&&(q||(k=g),g=b)}b<c.min&&(c.min=b);b>c.max&&(c.max=b);f<d.min&&(d.min=f);n>d.max&&(d.max=n);0<r&&(a.axisX.logarithmic?(C=b/h.dataPoints[r-1].x,1>C&&(C=1/C),c.minDiff>C&&1!==C&&(c.minDiff=C)):(C=b-h.dataPoints[r-1].x,0>C&&(C*=-1),c.minDiff>
C&&0!==C&&(c.minDiff=C)),e&&(null!==e[0]&&h.dataPoints[r-1].y&&null!==h.dataPoints[r-1].y[0])&&(a.axisY.logarithmic?(C=e[0]/h.dataPoints[r-1].y[0],1>C&&(C=1/C),d.minDiff>C&&1!==C&&(d.minDiff=C)):(C=e[0]-h.dataPoints[r-1].y[0],0>C&&(C*=-1),d.minDiff>C&&0!==C&&(d.minDiff=C))));if(!(b<l)||q){if(!q&&(q=!0,0<r)){r-=2;g=k;continue}if(b>u&&!p)p=!0;else if(b>u&&p)continue;h.dataPoints[r].label&&(a.axisX.labels[b]=h.dataPoints[r].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);
if(c.viewPortMin===b&&e)for(x=0;x<e.length;x++)if(null===e[x]&&g<b){c.viewPortMin=g;break}null===e?c.viewPortMin===b&&g<b&&(c.viewPortMin=g):(f<d.viewPortMin&&(d.viewPortMin=f),n>d.viewPortMax&&(d.viewPortMax=n))}}h.axisX.valueType=h.xValueType=m?"dateTime":"number"}};l.prototype._processSpecificPlotUnit=function(a){if("waterfall"===a.type&&a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length))for(var d=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f=!1,n=0;n<a.dataSeriesIndexes.length;n++){var m=this.data[a.dataSeriesIndexes[n]],
A=0,h=!1,r=!1,q=b=0;if("normal"===m.axisPlacement||"xySwapped"===m.axisPlacement)var p=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:this.options.axisX&&this.options.axisX.viewportMinimum?this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?this.options.axisX.minimum:a.axisX.logarithmic?0:-Infinity,g=a.axisX.sessionVariables.newViewportMaximum?a.axisX.sessionVariables.newViewportMaximum:this.options.axisX&&this.options.axisX.viewportMaximum?
...
q&&1!==q&&(c.minDiff=q)):(q=b-m.dataPoints[A-1].x,0>q&&(q*=-1),c.minDiff>q&&0!==q&&(c.minDiff=q)),null!==e&&null!==m.dataPoints[A-1].y&&(a.axisY.logarithmic?(e=m.dataPointEOs[A].cumulativeSum/m.dataPointEOs[A-1].cumulativeSum,1>e&&(e=1/e),d.minDiff>e&&1!==e&&(d.minDiff=e)):(e=m.dataPointEOs[A].cumulativeSum-m.dataPointEOs[A-1].cumulativeSum,0>e&&(e*=-1),d.minDiff>e&&0!==e&&(d.minDiff=e)))),!(b<p)||h){if(!h&&(h=!0,0<A)){A-=2;continue}if(b>g&&!r)r=!0;else if(b>g&&r)continue;m.dataPoints[A].label&&(a.axisX.labels[b]=
...
c=a.axisY.scaleBreaks&&a.axisY.scaleBreaks.autoCalculate&&1<=a.axisY.scaleBreaks.maxNumberOfAutoBreaks;if(b||c)for(var d=a.axisY.dataInfo,f=a.axisX.dataInfo,g,h=f.min,n=f.max,m=d.min,r=d.max,f=f._dataRanges,d=d._dataRanges,p,q=0,A=0;A<a.dataSeriesIndexes.length;A++){var k=e.data[a.dataSeriesIndexes[A]];if(!(4>k.dataPoints.length))for(q=0;q<k.dataPoints.length;q++)if(b&&(p=(n+1-h)*Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold)||10,10)/100,g=k.dataPoints[q].x.getTime?k.dataPoints[q].x.getTime():
k.dataPoints[q].x,p=Math.floor((g-h)/p),g<f[p].min&&(f[p].min=g),g>f[p].max&&(f[p].max=g)),c){var l=(r+1-m)*Math.max(parseFloat(a.axisY.scaleBreaks.collapsibleThreshold)||10,10)/100;if((g="waterfall"===a.type?k.dataPointEOs[q].cumulativeSum:k.dataPoints[q].y)&&g.length)for(var t=0;t<g.length;t++)p=Math.floor((g[t]-m)/l),g[t]<d[p].min&&(d[p].min=g[t]),g[t]>d[p].max&&(d[p].max=g[t]);else s(g)||(p=Math.floor((g-m)/l),g<d[p].min&&(d[p].min=g),g>d[p].max&&(d[p].max=g))}}}}function c(a){if(a.dataSeriesIndexes&&
!(1>a.dataSeriesIndexes.length)&&a.axisX.scaleBreaks&&a.axisX.scaleBreaks.autoCalculate&&1<=a.axisX.scaleBreaks.maxNumberOfAutoBreaks)for(var b=a.axisX.dataInfo,c=b.min,d=b.max,f=b._dataRanges,g,h=0,n=0;n<a.dataSeriesIndexes.length;n++){var m=e.data[a.dataSeriesIndexes[n]];if(!(4>m.dataPoints.length))for(h=0;h<m.dataPoints.length;h++)g=(d+1-c)*Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold)||10,10)/100,b=m.dataPoints[h].x.getTime?m.dataPoints[h].x.getTime():m.dataPoints[h].x,g=Math.floor((b-
c)/g),b<f[g].min&&(f[g].min=b),b>f[g].max&&(f[g].max=b)}}for(var b,e=this,f=!1,n=0;n<this._axes.length;n++)if(this._axes[n].scaleBreaks&&this._axes[n].scaleBreaks.autoCalculate&&1<=this._axes[n].scaleBreaks.maxNumberOfAutoBreaks){f=!0;this._axes[n].dataInfo._dataRanges=[];for(var m=0;m<100/Math.max(parseFloat(this._axes[n].scaleBreaks.collapsibleThreshold)||10,10);m++)this._axes[n].dataInfo._dataRanges.push({min:Infinity,max:-Infinity})}if(f){for(n=0;n<this.plotInfo.plotTypes.length;n++)for(f=this.plotInfo.plotTypes[n],
...
this._axes[n].dataInfo.min;b=(this._axes[n].dataInfo.max+1-A)*Math.max(parseFloat(this._axes[n].scaleBreaks.collapsibleThreshold)||10,10)/100;var h=this._axes[n].dataInfo._dataRanges,r,q,f=[];if(this._axes[n].dataInfo.dataPointYPositiveSums){var p=this._axes[n].dataInfo.dataPointYPositiveSums;r=h;for(m in p)if(p.hasOwnProperty(m)&&!isNaN(m)&&(q=p[m],!s(q))){var g=Math.floor((q-A)/b);q<r[g].min&&(r[g].min=q);q>r[g].max&&(r[g].max=q)}delete this._axes[n].dataInfo.dataPointYPositiveSums}if(this._axes[n].dataInfo.dataPointYNegativeSums){p=
this._axes[n].dataInfo.dataPointYNegativeSums;r=h;for(m in p)p.hasOwnProperty(m)&&!isNaN(m)&&(q=-1*p[m],s(q)||(g=Math.floor((q-A)/b),q<r[g].min&&(r[g].min=q),q>r[g].max&&(r[g].max=q)));delete this._axes[n].dataInfo.dataPointYNegativeSums}for(m=0;m<h.length-1;m++)if(r=h[m].max,isFinite(r))for(;m<h.length-1;)if(A=h[m+1].min,isFinite(A)){q=A-r;q>b&&f.push({diff:q,start:r,end:A});break}else m++;if(this._axes[n].scaleBreaks.customBreaks)for(m=0;m<this._axes[n].scaleBreaks.customBreaks.length;m++)for(b=
...
"area"!==b[c].dataSeries.type&&"stepArea"!==b[c].dataSeries.type||(a?b[c].distance<=a.distance&&(a=b[c]):a=b[c]);return a};l.prototype.getObjectAtXY=function(a,d,c){var b=null;if(c=this.getDataPointAtXY(a,d,c||!1))b=c.dataSeries.dataPointIds[c.dataPointIndex];else if(t)b=Za(a,d,this._eventManager.ghostCtx);else for(c=0;c<this.legend.items.length;c++){var e=this.legend.items[c];a>=e.x1&&(a<=e.x2&&d>=e.y1&&d<=e.y2)&&(b=e.id)}return b};l.prototype.getAutoFontSize=lb;l.prototype.resetOverlayedCanvas=
...
case "touchend":case "MSPointerUp":var f=this._lastTouchData&&this._lastTouchData.time?new Date-this._lastTouchData.time:0,d="touchstart"===this._lastTouchEventType||"MSPointerDown"===this._lastTouchEventType||300>f?["mouseup","click"]:["mouseup"];break;default:return}if(!(c&&1<c.length)){e=Oa(b);e.time=new Date;try{var n=e.y-this._lastTouchData.y,f=e.time-this._lastTouchData.time;if(1<Math.abs(n)&&this._lastTouchData.scroll||5<Math.abs(n)&&250>f)this._lastTouchData.scroll=!0}catch(m){}this._lastTouchEventType=
...
"rangeChanging",this.stockChart.dispatchEvent("rangeChanging",this.stockChart._rangeEventParameter,this.stockChart)),this.render(),this._dispatchRangeEvent("rangeChanged","zoom"),this.stockChart&&(this.stockChart.navigator&&this.stockChart.navigator.enabled)&&(this.stockChart._rangeEventParameter.type="rangeChanged",this.stockChart.dispatchEvent("rangeChanged",this.stockChart._rangeEventParameter,this.stockChart)),n&&(this.zoomEnabled&&"none"===this._zoomButton.style.display)&&(La(this._zoomButton,
...
{stockChart:this.stockChart,source:"chart",index:this.stockChart.charts.indexOf(this),minimum:e.val1,maximum:e.val2});return a.isValid};l.prototype.validateRegion=function(a,d,c,b,e){e=e||!1;for(var f=0<=this.zoomType.indexOf("x"),n=0<=this.zoomType.indexOf("y"),m=!1,A=[],h=[],r=[],q=0;q<this._axes.length;q++)("axisX"===this._axes[q].type&&f||"axisY"===this._axes[q].type&&n)&&h.push(this._axes[q]);for(n=0;n<h.length;n++){var q=h[n],f=!1,p=q.convertPixelToValue({x:a,y:d}),g=q.convertPixelToValue({x:c,
y:b});if(p>g)var C=g,g=p,p=C;if(q.scaleBreaks)for(C=0;!f&&C<q.scaleBreaks._appliedBreaks.length;C++)f=q.scaleBreaks._appliedBreaks[C].startValue<=p&&q.scaleBreaks._appliedBreaks[C].endValue>=g;if(isFinite(q.dataInfo.minDiff))if(C=q.getApparentDifference(p,g,null,!0),!(f||!(this.panEnabled&&q.scaleBreaks&&q.scaleBreaks._appliedBreaks.length)&&(q.logarithmic&&C<Math.pow(q.dataInfo.minDiff,3)||!q.logarithmic&&C<3*Math.abs(q.dataInfo.minDiff))||p<q.minimum||g>q.maximum))A.push(q),r.push({val1:p,val2:g}),
...
d.y1,a.y2=d.y2,a.width=d.width,a.height=d.height;t||(a.canvas.width=a.width,a.canvas.height=a.height,a.canvas.style.left=a.x1+"px",a.canvas.style.top=a.y1+"px",(0<a.x1||0<a.y1)&&a.ctx.translate(-a.x1,-a.y1));a.layoutManager=new Ea(a.x1,a.y1,a.x2,a.y2,2)};l.prototype.renderIndexLabels=function(a){var d=a||this.plotArea.ctx,c=this.plotArea,b=0,e=0,f=0,n=0,m=b=n=e=f=0,A=0;for(a=0;a<this._indexLabels.length;a++){var h=this._indexLabels[a],r=h.chartType.toLowerCase(),q,p,m=la("indexLabelFontColor",h.dataPoint,
h.dataSeries),A=la("indexLabelFontSize",h.dataPoint,h.dataSeries);q=la("indexLabelFontFamily",h.dataPoint,h.dataSeries);p=la("indexLabelFontStyle",h.dataPoint,h.dataSeries);var n=la("indexLabelFontWeight",h.dataPoint,h.dataSeries),g=la("indexLabelBackgroundColor",h.dataPoint,h.dataSeries),e=la("indexLabelMaxWidth",h.dataPoint,h.dataSeries),f=la("indexLabelWrap",h.dataPoint,h.dataSeries),C=la("indexLabelLineDashType",h.dataPoint,h.dataSeries),k=la("indexLabelLineColor",h.dataPoint,h.dataSeries),l=
s(h.dataPoint.indexLabelLineThickness)?s(h.dataSeries.options.indexLabelLineThickness)?0:h.dataSeries.options.indexLabelLineThickness:h.dataPoint.indexLabelLineThickness,b=0<l?Math.min(10,("normal"===this.plotInfo.axisPlacement?this.plotArea.height:this.plotArea.width)<<0):0,u={percent:null,total:null},x=null;if(0<=h.dataSeries.type.indexOf("stacked")||"pie"===h.dataSeries.type||"doughnut"===h.dataSeries.type)u=this.getPercentAndTotal(h.dataSeries,h.dataPoint);if(h.dataSeries.indexLabelFormatter||
h.dataPoint.indexLabelFormatter)x={chart:this,dataSeries:h.dataSeries,dataPoint:h.dataPoint,index:h.indexKeyword,total:u.total,percent:u.percent};var z=h.dataPoint.indexLabelFormatter?h.dataPoint.indexLabelFormatter(x):h.dataPoint.indexLabel?this.replaceKeywordsWithValue(h.dataPoint.indexLabel,h.dataPoint,h.dataSeries,null,h.indexKeyword):h.dataSeries.indexLabelFormatter?h.dataSeries.indexLabelFormatter(x):h.dataSeries.indexLabel?this.replaceKeywordsWithValue(h.dataSeries.indexLabel,h.dataPoint,h.dataSeries,
null,h.indexKeyword):null;if(null!==z&&""!==z){var u=la("indexLabelPlacement",h.dataPoint,h.dataSeries),x=la("indexLabelOrientation",h.dataPoint,h.dataSeries),D=h.direction,y=h.dataSeries.axisX,B=h.dataSeries.axisY,v=!1,g=new ja(d,{x:0,y:0,maxWidth:e?e:0.5*this.width,maxHeight:f?5*A:1.5*A,angle:"horizontal"===x?0:-90,text:z,padding:0,backgroundColor:g,horizontalAlign:"left",fontSize:A,fontFamily:q,fontWeight:n,fontColor:m,fontStyle:p,textBaseline:"top"});g.measureText();h.dataSeries.indexLabelMaxWidth=
g.maxWidth;if("stackedarea100"===r){if(h.point.x<c.x1||h.point.x>c.x2||h.point.y<c.y1-1||h.point.y>c.y2+1)continue}else if("rangearea"===r||"rangesplinearea"===r){if(h.dataPoint.x<y.viewportMinimum||h.dataPoint.x>y.viewportMaximum||Math.max.apply(null,h.dataPoint.y)<B.viewportMinimum||Math.min.apply(null,h.dataPoint.y)>B.viewportMaximum)continue}else if(0<=r.indexOf("line")||0<=r.indexOf("area")||0<=r.indexOf("bubble")||0<=r.indexOf("scatter")){if(h.dataPoint.x<y.viewportMinimum||h.dataPoint.x>y.viewportMaximum||
h.dataPoint.y<B.viewportMinimum||h.dataPoint.y>B.viewportMaximum)continue}else if(0<=r.indexOf("column")||"waterfall"===r||"error"===r&&!h.axisSwapped){if(h.dataPoint.x<y.viewportMinimum||h.dataPoint.x>y.viewportMaximum||h.bounds.y1>c.y2||h.bounds.y2<c.y1)continue}else if(0<=r.indexOf("bar")||"error"===r){if(h.dataPoint.x<y.viewportMinimum||h.dataPoint.x>y.viewportMaximum||h.bounds.x1>c.x2||h.bounds.x2<c.x1)continue}else if("candlestick"===r||"ohlc"===r){if(h.dataPoint.x<y.viewportMinimum||h.dataPoint.x>
y.viewportMaximum||Math.max.apply(null,h.dataPoint.y)<B.viewportMinimum||Math.min.apply(null,h.dataPoint.y)>B.viewportMaximum)continue}else if(h.dataPoint.x<y.viewportMinimum||h.dataPoint.x>y.viewportMaximum)continue;e=n=2;"horizontal"===x?(m=g.width,A=g.height):(A=g.width,m=g.height);if("normal"===this.plotInfo.axisPlacement){if(0<=r.indexOf("line")||0<=r.indexOf("area"))u="auto",n=4;else if(0<=r.indexOf("stacked"))"auto"===u&&(u="inside");else if("bubble"===r||"scatter"===r)u="inside";q=h.point.x-
m/2;"inside"!==u?(e=c.y1,f=c.y2,0<D?(p=h.point.y-A-n-b,p<e&&(p="auto"===u?Math.max(h.point.y,e)+n+b:e+n+b,v=p+A>h.point.y)):(p=h.point.y+n+b,p>f-A-n-b&&(p="auto"===u?Math.min(h.point.y,f)-A-n-b:f-A-n-b,v=p<h.point.y))):(e=Math.max(h.bounds.y1,c.y1),f=Math.min(h.bounds.y2,c.y2),b=0<=r.indexOf("range")||"error"===r?0<D?Math.max(h.bounds.y1,c.y1)+A/2+n:Math.min(h.bounds.y2,c.y2)-A/2-n:(Math.max(h.bounds.y1,c.y1)+Math.min(h.bounds.y2,c.y2))/2,0<D?(p=Math.max(h.point.y,b)-A/2,p<e&&("bubble"===r||"scatter"===
r)&&(p=Math.max(h.point.y-A-n,c.y1+n))):(p=Math.min(h.point.y,b)-A/2,p>f-A-n&&("bubble"===r||"scatter"===r)&&(p=Math.min(h.point.y+n,c.y2-A-n))),p=Math.min(p,f-A))}else 0<=r.indexOf("line")||0<=r.indexOf("area")||0<=r.indexOf("scatter")?(u="auto",e=4):0<=r.indexOf("stacked")?"auto"===u&&(u="inside"):"bubble"===r&&(u="inside"),p=h.point.y-A/2,"inside"!==u?(n=c.x1,f=c.x2,0>D?(q=h.point.x-m-e-b,q<n&&(q="auto"===u?Math.max(h.point.x,n)+e+b:n+e+b,v=q+m>h.point.x)):(q=h.point.x+e+b,q>f-m-e-b&&(q="auto"===
u?Math.min(h.point.x,f)-m-e-b:f-m-e-b,v=q<h.point.x))):(n=Math.max(h.bounds.x1,c.x1),Math.min(h.bounds.x2,c.x2),b=0<=r.indexOf("range")||"error"===r?0>D?Math.max(h.bounds.x1,c.x1)+m/2+e:Math.min(h.bounds.x2,c.x2)-m/2-e:(Math.max(h.bounds.x1,c.x1)+Math.min(h.bounds.x2,c.x2))/2,q=0>D?Math.max(h.point.x,b)-m/2:Math.min(h.point.x,b)-m/2,q=Math.max(q,n));"vertical"===x&&(p+=A);g.x=q;g.y=p;g.render(!0);l&&("inside"!==u&&(0>r.indexOf("bar")&&("error"!==r||!h.axisSwapped)&&h.point.x>c.x1&&h.point.x<c.x2||
!v)&&(0>r.indexOf("column")&&("error"!==r||h.axisSwapped)&&h.point.y>c.y1&&h.point.y<c.y2||!v))&&(d.lineWidth=l,d.strokeStyle=k?k:"gray",d.setLineDash&&d.setLineDash(N(C,l)),d.beginPath(),d.moveTo(h.point.x,h.point.y),0<=r.indexOf("bar")||"error"===r&&h.axisSwapped?d.lineTo(q+(0<h.direction?0:m),p+("horizontal"===x?A:-A)/2):0<=r.indexOf("column")||"error"===r&&!h.axisSwapped?d.lineTo(q+m/2,p+((0<h.direction?A:-A)+("horizontal"===x?A:-A))/2):d.lineTo(q+m/2,p+((p<h.point.y?A:-A)+("horizontal"===x?A:
-A))/2),d.stroke())}}d={source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0,startTimePercent:0.7};for(a=0;a<this._indexLabels.length;a++)h=this._indexLabels[a],g=la("indexLabelBackgroundColor",h.dataPoint,h.dataSeries),h.dataSeries.indexLabelBackgroundColor=s(g)?t?"transparent":null:g;return d};l.prototype.renderLine=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=t?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=
...
A=C[f].x,!(A<a.axisX.dataInfo.viewPortMin||A>a.axisX.dataInfo.viewPortMax)&&"number"===typeof C[f].y){n=a.axisX.convertValueToPixel(A);m=a.axisY.convertValueToPixel(C[f].y);n=a.axisX.reversed?n+a.plotType.totalDataSeries*q/2-(a.previousDataSeriesCount+r)*q<<0:n-a.plotType.totalDataSeries*q/2+(a.previousDataSeriesCount+r)*q<<0;var l=a.axisX.reversed?n-q<<0:n+q<<0,u;0<=C[f].y?u=h:(u=m,m=h);m>u&&(b=m,m=u,u=b);b=C[f].color?C[f].color:g._colorSet[f%g._colorSet.length];ba(c,n,m,l,u,b,0,null,k&&0<=C[f].y,
0>C[f].y&&k,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:p,dataPointIndex:f,x1:n,y1:m,x2:l,y2:u};b=Q(b);t&&ba(this._eventManager.ghostCtx,n,m,l,u,b,0,null,!1,!1,!1,!1);(C[f].indexLabel||g.indexLabel||C[f].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"column",dataPoint:C[f],dataSeries:g,point:{x:n+(l-n)/2,y:0>C[f].y===a.axisY.reversed?m:u},direction:0>C[f].y===a.axisY.reversed?1:-1,bounds:{x1:n,
...
return{source:d,dest:this.plotArea.ctx,animationCallback:M.yScaleAnimation,easingFunction:M.easing.easeOutQuart,animationBase:h<a.axisY.bounds.y1?a.axisY.bounds.y1:h>a.axisY.bounds.y2?a.axisY.bounds.y2:h}}};l.prototype.renderStackedColumn=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=t?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=[],n=[],m=[],A=[],h=0,r,q,p=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),h=this.options.dataPointMinWidth?
...
this.dataPointWidth:Infinity,r));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&r<h)&&(r=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,h));g<h&&(g=h);g>r&&(g=r);c.save();t&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();t&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var C=0;C<a.dataSeriesIndexes.length;C++){var k=a.dataSeriesIndexes[C],
l=this.data[k],u=l.dataPoints;if(0<u.length){var s=5<g&&l.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(h=0;h<u.length;h++)if(b=u[h].x.getTime?u[h].x.getTime():u[h].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof u[h].y){r=a.axisX.convertValueToPixel(b);var z=r-a.plotType.plotUnits.length*g/2+a.index*g<<0,D=z+g<<0,y;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<u[h].y)m[b]=u[h].y+(m[b]?m[b]:0),0<m[b]&&(q=a.axisY.convertValueToPixel(m[b]),
y="undefined"!==typeof f[b]?f[b]:p,f[b]=q);else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=u[h].y)A[b]=u[h].y+(A[b]?A[b]:0),y=a.axisY.convertValueToPixel(A[b]),q="undefined"!==typeof n[b]?n[b]:p,n[b]=y;else if(q=a.axisY.convertValueToPixel(u[h].y),0<=u[h].y){var B="undefined"!==typeof f[b]?f[b]:0;q-=B;y=p-B;f[b]=B+(y-q)}else B=n[b]?n[b]:0,y=q+B,q=p+B,n[b]=B+(y-q);b=u[h].color?u[h].color:l._colorSet[h%l._colorSet.length];ba(c,z,q,D,y,b,0,null,s&&0<=u[h].y,0>u[h].y&&s,!1,
!1,l.fillOpacity);b=l.dataPointIds[h];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:h,x1:z,y1:q,x2:D,y2:y};b=Q(b);t&&ba(this._eventManager.ghostCtx,z,q,D,y,b,0,null,!1,!1,!1,!1);(u[h].indexLabel||l.indexLabel||u[h].indexLabelFormatter||l.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedColumn",dataPoint:u[h],dataSeries:l,point:{x:r,y:0<=u[h].y?q:y},direction:0>u[h].y===a.axisY.reversed?1:-1,bounds:{x1:z,y1:Math.min(q,y),x2:D,y2:Math.max(q,
...
animationCallback:M.yScaleAnimation,easingFunction:M.easing.easeOutQuart,animationBase:p<a.axisY.bounds.y1?a.axisY.bounds.y1:p>a.axisY.bounds.y2?a.axisY.bounds.y2:p}}};l.prototype.renderStackedColumn100=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=t?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=[],n=[],m=[],A=[],h=0,r,q,p=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),h=this.options.dataPointMinWidth?this.dataPointMinWidth:
this.options.dataPointWidth?this.dataPointWidth:1;r=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:0.15*this.width<<0;var g=a.axisX.dataInfo.minDiff;isFinite(g)||(g=0.3*Math.abs(a.axisX.range));g=this.options.dataPointWidth?this.dataPointWidth:0.9*(e.width*(a.axisX.logarithmic?Math.log(g)/Math.log(a.axisX.range):Math.abs(g)/Math.abs(a.axisX.range))/a.plotType.plotUnits.length)<<0;this.dataPointMaxWidth&&h>r&&(h=Math.min(this.options.dataPointWidth?
this.dataPointWidth:Infinity,r));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&r<h)&&(r=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,h));g<h&&(g=h);g>r&&(g=r);c.save();t&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();t&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var C=0;C<a.dataSeriesIndexes.length;C++){var k=a.dataSeriesIndexes[C],
l=this.data[k],u=l.dataPoints;if(0<u.length)for(var s=5<g&&l.bevelEnabled?!0:!1,h=0;h<u.length;h++)if(b=u[h].x.getTime?u[h].x.getTime():u[h].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof u[h].y){r=a.axisX.convertValueToPixel(b);q=0!==a.dataPointYSums[b]?100*(u[h].y/a.dataPointYSums[b]):0;var z=r-a.plotType.plotUnits.length*g/2+a.index*g<<0,D=z+g<<0,y;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<u[h].y){m[b]=q+
...
this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.yScaleAnimation,easingFunction:M.easing.easeOutQuart,animationBase:p<a.axisY.bounds.y1?a.axisY.bounds.y1:p>a.axisY.bounds.y2?a.axisY.bounds.y2:p}}};l.prototype.renderBar=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=t?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=
null,e=this.plotArea,f=0,n,m,A,h=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),f=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1,r=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:Math.min(0.15*this.height,0.9*(this.plotArea.height/a.plotType.totalDataSeries))<<0,q=a.axisX.dataInfo.minDiff;isFinite(q)||(q=0.3*Math.abs(a.axisX.range));q=this.options.dataPointWidth?
...
Q(b);t&&ba(this._eventManager.ghostCtx,u,m,n,l,b,0,null,!1,!1,!1,!1);(C[f].indexLabel||g.indexLabel||C[f].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"bar",dataPoint:C[f],dataSeries:g,point:{x:0<=C[f].y?n:u,y:m+(l-m)/2},direction:0>C[f].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(u,n),y1:m,x2:Math.max(u,n),y2:l},color:b})}}}t&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,
0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.xScaleAnimation,easingFunction:M.easing.easeOutQuart,animationBase:h<a.axisY.bounds.x1?a.axisY.bounds.x1:h>a.axisY.bounds.x2?a.axisY.bounds.x2:
h}}};l.prototype.renderStackedBar=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=t?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=[],n=[],m=[],A=[],h=0,r,q,p=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),h=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;q=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:0.15*this.height<<
...
h&&(g=h);g>q&&(g=q);c.save();t&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();t&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var C=0;C<a.dataSeriesIndexes.length;C++){var k=a.dataSeriesIndexes[C],l=this.data[k],u=l.dataPoints;if(0<u.length){var s=5<g&&l.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(h=0;h<u.length;h++)if(b=u[h].x.getTime?u[h].x.getTime():
u[h].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof u[h].y){q=a.axisX.convertValueToPixel(b);var z=q-a.plotType.plotUnits.length*g/2+a.index*g<<0,D=z+g<<0,y;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<u[h].y)m[b]=u[h].y+(m[b]?m[b]:0),0<m[b]&&(y=f[b]?f[b]:p,f[b]=r=a.axisY.convertValueToPixel(m[b]));else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=u[h].y)A[b]=u[h].y+(A[b]?A[b]:0),r=n[b]?
n[b]:p,n[b]=y=a.axisY.convertValueToPixel(A[b]);else if(r=a.axisY.convertValueToPixel(u[h].y),0<=u[h].y){var B=f[b]?f[b]:0;y=p+B;r+=B;f[b]=B+(r-y)}else B=n[b]?n[b]:0,y=r-B,r=p-B,n[b]=B+(r-y);b=u[h].color?u[h].color:l._colorSet[h%l._colorSet.length];ba(c,y,z,r,D,b,0,null,s,!1,!1,!1,l.fillOpacity);b=l.dataPointIds[h];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:h,x1:y,y1:z,x2:r,y2:D};b=Q(b);t&&ba(this._eventManager.ghostCtx,y,z,r,D,b,0,null,!1,!1,!1,
!1);(u[h].indexLabel||l.indexLabel||u[h].indexLabelFormatter||l.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar",dataPoint:u[h],dataSeries:l,point:{x:0<=u[h].y?r:y,y:q},direction:0>u[h].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(y,r),y1:z,x2:Math.max(y,r),y2:D},color:b})}}}t&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&
c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.xScaleAnimation,easingFunction:M.easing.easeOutQuart,animationBase:p<a.axisY.bounds.x1?a.axisY.bounds.x1:p>a.axisY.bounds.x2?a.axisY.bounds.x2:p}}};l.prototype.renderStackedBar100=function(a){var d=
a.targetCanvasCtx||this.plotArea.ctx,c=t?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=[],n=[],m=[],A=[],h=0,r,q,p=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),h=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;q=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:0.15*this.height<<0;var g=a.axisX.dataInfo.minDiff;isFinite(g)||
(g=0.3*Math.abs(a.axisX.range));g=this.options.dataPointWidth?this.dataPointWidth:0.9*(e.height*(a.axisX.logarithmic?Math.log(g)/Math.log(a.axisX.range):Math.abs(g)/Math.abs(a.axisX.range))/a.plotType.plotUnits.length)<<0;this.dataPointMaxWidth&&h>q&&(h=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,q));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&q<h)&&(q=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,h));g<h&&(g=h);g>q&&(g=q);c.save();t&&this._eventManager.ghostCtx.save();
...
"number"===typeof u[h].y){q=a.axisX.convertValueToPixel(b);var z;z=0!==a.dataPointYSums[b]?100*(u[h].y/a.dataPointYSums[b]):0;var D=q-a.plotType.plotUnits.length*g/2+a.index*g<<0,y=D+g<<0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<u[h].y){m[b]=z+(m[b]?m[b]:0);if(0>=m[b])continue;z=f[b]?f[b]:p;f[b]=r=a.axisY.convertValueToPixel(m[b])}else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=u[h].y)A[b]=z+(A[b]?A[b]:0),r=n[b]?n[b]:
p,n[b]=z=a.axisY.convertValueToPixel(A[b]);else if(r=a.axisY.convertValueToPixel(z),0<=u[h].y){var B=f[b]?f[b]:0;z=p+B;r+=B;a.dataSeriesIndexes.length-1===C&&1>=Math.abs(e.x2-r)&&(r=e.x2);f[b]=B+(r-z)}else B=n[b]?n[b]:0,z=r-B,r=p-B,a.dataSeriesIndexes.length-1===C&&1>=Math.abs(e.x1-z)&&(z=e.x1),n[b]=B+(r-z);b=u[h].color?u[h].color:l._colorSet[h%l._colorSet.length];ba(c,z,D,r,y,b,0,null,s,!1,!1,!1,l.fillOpacity);b=l.dataPointIds[h];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:k,
dataPointIndex:h,x1:z,y1:D,x2:r,y2:y};b=Q(b);t&&ba(this._eventManager.ghostCtx,z,D,r,y,b,0,null,!1,!1,!1,!1);(u[h].indexLabel||l.indexLabel||u[h].indexLabelFormatter||l.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar100",dataPoint:u[h],dataSeries:l,point:{x:0<=u[h].y?r:z,y:q},direction:0>u[h].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(z,r),y1:D,x2:Math.max(z,r),y2:y},color:b})}}}t&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",
a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.xScaleAnimation,easingFunction:M.easing.easeOutQuart,animationBase:p<a.axisY.bounds.x1?a.axisY.bounds.x1:
p>a.axisY.bounds.x2?a.axisY.bounds.x2:p}}};l.prototype.renderArea=function(a){var d,c;function b(){y&&(0<g.lineThickness&&f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?D=z:0>a.axisY.viewportMaximum?D=m.y1:0<a.axisY.viewportMinimum&&(D=z),f.lineTo(l,D),f.lineTo(y.x,D),f.closePath(),f.globalAlpha=g.fillOpacity,f.fill(),f.globalAlpha=1,t&&(n.lineTo(l,D),n.lineTo(y.x,D),n.closePath(),n.fill()),f.beginPath(),f.moveTo(l,u),n.beginPath(),n.moveTo(l,u),y={x:l,y:u})}
var e=a.targetCanvasCtx||this.plotArea.ctx,f=t?this._preRenderCtx:e;if(!(0>=a.dataSeriesIndexes.length)){var n=this._eventManager.ghostCtx,m=a.axisY.lineCoordinates,A=[],h=this.plotArea,r;f.save();t&&n.save();f.beginPath();f.rect(h.x1,h.y1,h.width,h.height);f.clip();t&&(n.beginPath(),n.rect(h.x1,h.y1,h.width,h.height),n.clip());for(var q=0;q<a.dataSeriesIndexes.length;q++){var p=a.dataSeriesIndexes[q],g=this.data[p],C=g.dataPoints,A=g.id;this._eventManager.objectMap[A]={objectType:"dataSeries",dataSeriesIndex:p};
A=Q(A);n.fillStyle=A;A=[];d=!0;var k=0,l,u,s,z=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),D,y=null;if(0<C.length){var B=g._colorSet[k%g._colorSet.length],v=g.lineColor=g.options.lineColor||B,w=v;f.fillStyle=B;f.strokeStyle=v;f.lineWidth=g.lineThickness;c="solid";if(f.setLineDash){var T=N(g.nullDataLineDashType,g.lineThickness);c=g.lineDashType;var S=N(c,g.lineThickness);f.setLineDash(S)}for(var ka=!0;k<C.length;k++)if(s=C[k].x.getTime?C[k].x.getTime():C[k].x,!(s<a.axisX.dataInfo.viewPortMin||
s>a.axisX.dataInfo.viewPortMax&&(!g.connectNullData||!ka)))if("number"!==typeof C[k].y)g.connectNullData||(ka||d)||b(),ka=!0;else{l=a.axisX.convertValueToPixel(s);u=a.axisY.convertValueToPixel(C[k].y);d||ka?(!d&&g.connectNullData?(f.setLineDash&&(g.options.nullDataLineDashType||c===g.lineDashType&&g.lineDashType!==g.nullDataLineDashType)&&(d=l,c=u,l=r.x,u=r.y,b(),f.moveTo(r.x,r.y),l=d,u=c,y=r,c=g.nullDataLineDashType,f.setLineDash(T)),f.lineTo(l,u),t&&n.lineTo(l,u)):(f.beginPath(),f.moveTo(l,u),t&&
(n.beginPath(),n.moveTo(l,u)),y={x:l,y:u}),ka=d=!1):(f.lineTo(l,u),t&&n.lineTo(l,u),0==k%250&&b());r={x:l,y:u};k<C.length-1&&(w!==(C[k].lineColor||v)||c!==(C[k].lineDashType||g.lineDashType))&&(b(),w=C[k].lineColor||v,f.strokeStyle=w,f.setLineDash&&(C[k].lineDashType?(c=C[k].lineDashType,f.setLineDash(N(c,g.lineThickness))):(c=g.lineDashType,f.setLineDash(S))));var Z=g.dataPointIds[k];this._eventManager.objectMap[Z]={id:Z,objectType:"dataPoint",dataSeriesIndex:p,dataPointIndex:k,x1:l,y1:u};0!==C[k].markerSize&&
(0<C[k].markerSize||0<g.markerSize)&&(s=g.getMarkerProperties(k,l,u,f),A.push(s),Z=Q(Z),t&&A.push({x:l,y:u,ctx:n,type:s.type,size:s.size,color:Z,borderColor:Z,borderThickness:s.borderThickness}));(C[k].indexLabel||g.indexLabel||C[k].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"area",dataPoint:C[k],dataSeries:g,point:{x:l,y:u},direction:0>C[k].y===a.axisY.reversed?1:-1,color:B})}b();W.drawMarkers(A)}}t&&(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),
f.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&f.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&f.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.clearRect(h.x1,h.y1,h.width,h.height),this._eventManager.ghostCtx.restore());f.restore();return{source:e,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};
...
B=r.nullDataLineDashType):(d(),s=[])),C=!0;else{g=a.axisX.convertValueToPixel(g);C=a.axisY.convertValueToPixel(q[p].y);var T=r.dataPointIds[p];this._eventManager.objectMap[T]={id:T,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:p,x1:g,y1:C};s[s.length]={x:g,y:C};p<q.length-1&&(y!==(q[p].lineColor||D)||B!==(q[p].lineDashType||r.lineDashType))&&(y=q[p].lineColor||D,s[s.length-1].newStrokeStyle=y,b.setLineDash&&(q[p].lineDashType?(B=q[p].lineDashType,s[s.length-1].newLineDashArray=N(B,r.lineThickness)):
(B=r.lineDashType,s[s.length-1].newLineDashArray=E)));if(0!==q[p].markerSize&&(0<q[p].markerSize||0<r.markerSize)){var S=r.getMarkerProperties(p,g,C,b);n.push(S);T=Q(T);t&&n.push({x:g,y:C,ctx:e,type:S.type,size:S.size,color:T,borderColor:T,borderThickness:S.borderThickness})}(q[p].indexLabel||r.indexLabel||q[p].indexLabelFormatter||r.indexLabelFormatter)&&this._indexLabels.push({chartType:"splineArea",dataPoint:q[p],dataSeries:r,point:{x:g,y:C},direction:0>q[p].y===a.axisY.reversed?1:-1,color:z});
C=!1}d();W.drawMarkers(n)}}t&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(m.x1,m.y1,m.width,m.height),this._eventManager.ghostCtx.restore());b.restore();return{source:c,
dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};l.prototype.renderStepArea=function(a){var d,c;function b(){y&&(0<g.lineThickness&&f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?D=z:0>a.axisY.viewportMaximum?D=m.y1:0<a.axisY.viewportMinimum&&(D=z),f.lineTo(l,D),f.lineTo(y.x,D),f.closePath(),f.globalAlpha=g.fillOpacity,f.fill(),f.globalAlpha=1,t&&(n.lineTo(l,D),n.lineTo(y.x,D),n.closePath(),n.fill()),
f.beginPath(),f.moveTo(l,u),n.beginPath(),n.moveTo(l,u),y={x:l,y:u})}var e=a.targetCanvasCtx||this.plotArea.ctx,f=t?this._preRenderCtx:e;if(!(0>=a.dataSeriesIndexes.length)){var n=this._eventManager.ghostCtx,m=a.axisY.lineCoordinates,A=[],h=this.plotArea,r;f.save();t&&n.save();f.beginPath();f.rect(h.x1,h.y1,h.width,h.height);f.clip();t&&(n.beginPath(),n.rect(h.x1,h.y1,h.width,h.height),n.clip());for(var q=0;q<a.dataSeriesIndexes.length;q++){var p=a.dataSeriesIndexes[q],g=this.data[p],C=g.dataPoints,
A=g.id;this._eventManager.objectMap[A]={objectType:"dataSeries",dataSeriesIndex:p};A=Q(A);n.fillStyle=A;A=[];d=!0;var k=0,l,u,s,z=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),D,y=null;c=!1;if(0<C.length){var B=g._colorSet[k%g._colorSet.length],v=g.lineColor=g.options.lineColor||B,w=v;f.fillStyle=B;f.strokeStyle=v;f.lineWidth=g.lineThickness;var T="solid";if(f.setLineDash){var S=N(g.nullDataLineDashType,g.lineThickness),T=g.lineDashType,E=N(T,g.lineThickness);f.setLineDash(E)}for(;k<
C.length;k++)if(s=C[k].x.getTime?C[k].x.getTime():C[k].x,!(s<a.axisX.dataInfo.viewPortMin||s>a.axisX.dataInfo.viewPortMax&&(!g.connectNullData||!c))){var Z=u;"number"!==typeof C[k].y?(g.connectNullData||(c||d)||b(),c=!0):(l=a.axisX.convertValueToPixel(s),u=a.axisY.convertValueToPixel(C[k].y),d||c?(!d&&g.connectNullData?(f.setLineDash&&(g.options.nullDataLineDashType||T===g.lineDashType&&g.lineDashType!==g.nullDataLineDashType)&&(d=l,c=u,l=r.x,u=r.y,b(),f.moveTo(r.x,r.y),l=d,u=c,y=r,T=g.nullDataLineDashType,
f.setLineDash(S)),f.lineTo(l,Z),f.lineTo(l,u),t&&(n.lineTo(l,Z),n.lineTo(l,u))):(f.beginPath(),f.moveTo(l,u),t&&(n.beginPath(),n.moveTo(l,u)),y={x:l,y:u}),c=d=!1):(f.lineTo(l,Z),t&&n.lineTo(l,Z),f.lineTo(l,u),t&&n.lineTo(l,u),0==k%250&&b()),r={x:l,y:u},k<C.length-1&&(w!==(C[k].lineColor||v)||T!==(C[k].lineDashType||g.lineDashType))&&(b(),w=C[k].lineColor||v,f.strokeStyle=w,f.setLineDash&&(C[k].lineDashType?(T=C[k].lineDashType,f.setLineDash(N(T,g.lineThickness))):(T=g.lineDashType,f.setLineDash(E)))),
s=g.dataPointIds[k],this._eventManager.objectMap[s]={id:s,objectType:"dataPoint",dataSeriesIndex:p,dataPointIndex:k,x1:l,y1:u},0!==C[k].markerSize&&(0<C[k].markerSize||0<g.markerSize)&&(Z=g.getMarkerProperties(k,l,u,f),A.push(Z),s=Q(s),t&&A.push({x:l,y:u,ctx:n,type:Z.type,size:Z.size,color:s,borderColor:s,borderThickness:Z.borderThickness})),(C[k].indexLabel||g.indexLabel||C[k].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepArea",dataPoint:C[k],dataSeries:g,point:{x:l,
y:u},direction:0>C[k].y===a.axisY.reversed?1:-1,color:B}))}b();W.drawMarkers(A)}}t&&(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&f.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&f.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.clearRect(h.x1,h.y1,h.width,h.height),this._eventManager.ghostCtx.restore());
f.restore();return{source:e,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};l.prototype.renderStackedArea=function(a){function d(){if(!(1>h.length)){for(0<B.lineThickness&&b.stroke();0<h.length;){var a=h.pop();b.lineTo(a.x,a.y);t&&s.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=B.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();t&&(s.closePath(),s.fill(),s.beginPath());h=[]}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=t?this._preRenderCtx:
...
[];for(p=0;p<v.length;p++)y=v[p].x.getTime?v[p].x.getTime():v[p].x,B.dataPointIndexes[y]=p,e[y]||(r.push(y),e[y]=!0);r.sort(Qa)}for(D=0;D<a.dataSeriesIndexes.length;D++){y=a.dataSeriesIndexes[D];B=this.data[y];v=B.dataPoints;x=!0;h=[];p=B.id;this._eventManager.objectMap[p]={objectType:"dataSeries",dataSeriesIndex:y};p=Q(p);s.fillStyle=p;if(0<r.length){var e=B._colorSet[0],w=B.lineColor=B.options.lineColor||e,T=w;b.fillStyle=e;b.strokeStyle=w;b.lineWidth=B.lineThickness;z="solid";if(b.setLineDash){var S=
N(B.nullDataLineDashType,B.lineThickness);z=B.lineDashType;var E=N(z,B.lineThickness);b.setLineDash(E)}for(var Z=!0,p=0;p<r.length;p++){var f=r[p],ga=null,ga=0<=B.dataPointIndexes[f]?v[B.dataPointIndexes[f]]:{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!B.connectNullData||!Z)))if("number"!==typeof ga.y)B.connectNullData||(Z||x)||d(),Z=!0;else{g=a.axisX.convertValueToPixel(f);var ma=A[f]?A[f]:0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){q[f]=
ga.y+(q[f]?q[f]:0);if(0>=q[f]&&a.axisY.logarithmic)continue;k=a.axisY.convertValueToPixel(q[f])}else k=a.axisY.convertValueToPixel(ga.y),k-=ma;h.push({x:g,y:l-ma});A[f]=l-k;x||Z?(!x&&B.connectNullData?(b.setLineDash&&(B.options.nullDataLineDashType||z===B.lineDashType&&B.lineDashType!==B.nullDataLineDashType)&&(x=h.pop(),z=h[h.length-1],d(),b.moveTo(u.x,u.y),h.push(z),h.push(x),z=B.nullDataLineDashType,b.setLineDash(S)),b.lineTo(g,k),t&&s.lineTo(g,k)):(b.beginPath(),b.moveTo(g,k),t&&(s.beginPath(),
s.moveTo(g,k))),Z=x=!1):(b.lineTo(g,k),t&&s.lineTo(g,k),0==p%250&&(d(),b.moveTo(g,k),t&&s.moveTo(g,k),h.push({x:g,y:l-ma})));u={x:g,y:k};p<v.length-1&&(T!==(v[p].lineColor||w)||z!==(v[p].lineDashType||B.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,k),h.push({x:g,y:l-ma}),T=v[p].lineColor||w,b.strokeStyle=T,b.setLineDash&&(v[p].lineDashType?(z=v[p].lineDashType,b.setLineDash(N(z,B.lineThickness))):(z=B.lineDashType,b.setLineDash(E))));if(0<=B.dataPointIndexes[f]){var F=B.dataPointIds[B.dataPointIndexes[f]];
this._eventManager.objectMap[F]={id:F,objectType:"dataPoint",dataSeriesIndex:y,dataPointIndex:B.dataPointIndexes[f],x1:g,y1:k}}0<=B.dataPointIndexes[f]&&0!==ga.markerSize&&(0<ga.markerSize||0<B.markerSize)&&(ma=B.getMarkerProperties(B.dataPointIndexes[f],g,k,b),n.push(ma),f=Q(F),t&&n.push({x:g,y:k,ctx:s,type:ma.type,size:ma.size,color:f,borderColor:f,borderThickness:ma.borderThickness}));(ga.indexLabel||B.indexLabel||ga.indexLabelFormatter||B.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea",
dataPoint:ga,dataSeries:B,point:{x:g,y:k},direction:0>v[p].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(g,k);t&&s.moveTo(g,k)}delete B.dataPointIndexes}W.drawMarkers(n);t&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
0,0,this.width,this.height),b.clearRect(m.x1,m.y1,m.width,m.height),s.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};l.prototype.renderStackedArea100=function(a){function d(){for(0<B.lineThickness&&b.stroke();0<h.length;){var a=h.pop();b.lineTo(a.x,a.y);t&&z.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=B.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();t&&(z.closePath(),z.fill(),z.beginPath());h=[]}
var c=a.targetCanvasCtx||this.plotArea.ctx,b=t?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=null,n=this.plotArea,m=[],k=[],h=[],r=[],q=[],p=0,g,l,s,da,u,x=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),z=this._eventManager.ghostCtx;b.save();t&&z.save();b.beginPath();b.rect(n.x1,n.y1,n.width,n.height);b.clip();t&&(z.beginPath(),z.rect(n.x1,n.y1,n.width,n.height),z.clip());for(var e=[],D=0;D<a.dataSeriesIndexes.length;D++){var y=a.dataSeriesIndexes[D],
...
w;b.lineWidth=B.lineThickness;u="solid";if(b.setLineDash){var S=N(B.nullDataLineDashType,B.lineThickness);u=B.lineDashType;var E=N(u,B.lineThickness);b.setLineDash(E)}for(var Z=!0,p=0;p<r.length;p++){var f=r[p],ga=null,ga=0<=B.dataPointIndexes[f]?v[B.dataPointIndexes[f]]:{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!B.connectNullData||!Z)))if("number"!==typeof ga.y)B.connectNullData||(Z||da)||d(),Z=!0;else{var ma;ma=0!==a.dataPointYSums[f]?100*(ga.y/a.dataPointYSums[f]):
0;g=a.axisX.convertValueToPixel(f);var F=k[f]?k[f]:0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){q[f]=ma+(q[f]?q[f]:0);if(0>=q[f]&&a.axisY.logarithmic)continue;l=a.axisY.convertValueToPixel(q[f])}else l=a.axisY.convertValueToPixel(ma),l-=F;h.push({x:g,y:x-F});k[f]=x-l;da||Z?(!da&&B.connectNullData?(b.setLineDash&&(B.options.nullDataLineDashType||u===B.lineDashType&&B.lineDashType!==B.nullDataLineDashType)&&(da=h.pop(),u=h[h.length-1],d(),b.moveTo(s.x,
s.y),h.push(u),h.push(da),u=B.nullDataLineDashType,b.setLineDash(S)),b.lineTo(g,l),t&&z.lineTo(g,l)):(b.beginPath(),b.moveTo(g,l),t&&(z.beginPath(),z.moveTo(g,l))),Z=da=!1):(b.lineTo(g,l),t&&z.lineTo(g,l),0==p%250&&(d(),b.moveTo(g,l),t&&z.moveTo(g,l),h.push({x:g,y:x-F})));s={x:g,y:l};p<v.length-1&&(T!==(v[p].lineColor||w)||u!==(v[p].lineDashType||B.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,l),h.push({x:g,y:x-F}),T=v[p].lineColor||w,b.strokeStyle=T,b.setLineDash&&(v[p].lineDashType?(u=v[p].lineDashType,
b.setLineDash(N(u,B.lineThickness))):(u=B.lineDashType,b.setLineDash(E))));if(0<=B.dataPointIndexes[f]){var G=B.dataPointIds[B.dataPointIndexes[f]];this._eventManager.objectMap[G]={id:G,objectType:"dataPoint",dataSeriesIndex:y,dataPointIndex:B.dataPointIndexes[f],x1:g,y1:l}}0<=B.dataPointIndexes[f]&&0!==ga.markerSize&&(0<ga.markerSize||0<B.markerSize)&&(F=B.getMarkerProperties(p,g,l,b),m.push(F),f=Q(G),t&&m.push({x:g,y:l,ctx:z,type:F.type,size:F.size,color:f,borderColor:f,borderThickness:F.borderThickness}));
(ga.indexLabel||B.indexLabel||ga.indexLabelFormatter||B.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea100",dataPoint:ga,dataSeries:B,point:{x:g,y:l},direction:0>v[p].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(g,l);t&&z.moveTo(g,l)}delete B.dataPointIndexes}W.drawMarkers(m);t&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&
b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(n.x1,n.y1,n.width,n.height),z.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};l.prototype.renderBubble=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=t?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=
this.plotArea,e=0,f,n;c.save();t&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(b.x1,b.y1,b.width,b.height);c.clip();t&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(b.x1,b.y1,b.width,b.height),this._eventManager.ghostCtx.clip());for(var m=-Infinity,k=Infinity,h=0;h<a.dataSeriesIndexes.length;h++)for(var r=a.dataSeriesIndexes[h],q=this.data[r],p=q.dataPoints,g=0,e=0;e<p.length;e++)f=p[e].getTime?f=p[e].x.getTime():f=p[e].x,f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax||
...
var g=p[e].z,da=2*Math.max(Math.sqrt((m===k?s/2:l+(s-l)/(m-k)*(g-k))/Math.PI)<<0,1),g=q.getMarkerProperties(e,c);g.size=da;c.globalAlpha=q.fillOpacity;W.drawMarker(f,n,c,g.type,g.size,g.color,g.borderColor,g.borderThickness);c.globalAlpha=1;var u=q.dataPointIds[e];this._eventManager.objectMap[u]={id:u,objectType:"dataPoint",dataSeriesIndex:r,dataPointIndex:e,x1:f,y1:n,size:da};da=Q(u);t&&W.drawMarker(f,n,this._eventManager.ghostCtx,g.type,g.size,da,da,g.borderThickness);(p[e].indexLabel||q.indexLabel||
p[e].indexLabelFormatter||q.indexLabelFormatter)&&this._indexLabels.push({chartType:"bubble",dataPoint:p[e],dataSeries:q,point:{x:f,y:n},direction:1,bounds:{x1:f-g.size/2,y1:n-g.size/2,x2:f+g.size/2,y2:n+g.size/2},color:null})}t&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&
this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(b.x1,b.y1,b.width,b.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0}}};l.prototype.renderScatter=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=t?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this.plotArea,e=0,f,n;c.save();t&&this._eventManager.ghostCtx.save();
...
n.height),b.clip());for(var fa=0;fa<a.dataSeriesIndexes.length;fa++){var da=a.dataSeriesIndexes[fa],u=this.data[da],x=u.dataPoints;if(0<x.length)for(var z=5<l&&u.bevelEnabled?!0:!1,m=0;m<x.length;m++)if(x[m].getTime?g=x[m].x.getTime():g=x[m].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&!s(x[m].y)&&x[m].y.length&&"number"===typeof x[m].y[0]&&"number"===typeof x[m].y[1]&&"number"===typeof x[m].y[2]&&"number"===typeof x[m].y[3]){k=a.axisX.convertValueToPixel(g);h=a.axisY.convertValueToPixel(x[m].y[0]);
...
c.lineWidth=B;b.lineWidth=Math.max(B,4);"candlestick"===u.type?(c.moveTo(k-w,r),c.lineTo(k-w,Math.min(h,p)),c.stroke(),c.moveTo(k-w,Math.max(h,p)),c.lineTo(k-w,q),c.stroke(),ba(c,v,Math.min(h,p),y,Math.max(h,p),x[m].y[0]<=x[m].y[3]?u.risingColor:f,B,e,z,z,!1,!1,u.fillOpacity),t&&(e=Q(E),b.strokeStyle=e,b.moveTo(k-w,r),b.lineTo(k-w,Math.min(h,p)),b.stroke(),b.moveTo(k-w,Math.max(h,p)),b.lineTo(k-w,q),b.stroke(),ba(b,v,Math.min(h,p),y,Math.max(h,p),e,0,null,!1,!1,!1,!1))):"ohlc"===u.type&&(c.moveTo(k-
w,r),c.lineTo(k-w,q),c.stroke(),c.beginPath(),c.moveTo(k,h),c.lineTo(v,h),c.stroke(),c.beginPath(),c.moveTo(k,p),c.lineTo(y,p),c.stroke(),t&&(e=Q(E),b.strokeStyle=e,b.moveTo(k-w,r),b.lineTo(k-w,q),b.stroke(),b.beginPath(),b.moveTo(k,h),b.lineTo(v,h),b.stroke(),b.beginPath(),b.moveTo(k,p),b.lineTo(y,p),b.stroke()));(x[m].indexLabel||u.indexLabel||x[m].indexLabelFormatter||u.indexLabelFormatter)&&this._indexLabels.push({chartType:u.type,dataPoint:x[m],dataSeries:u,point:{x:v+(y-v)/2,y:a.axisY.reversed?
...
c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0}}};l.prototype.renderBoxAndWhisker=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=t?this._preRenderCtx:d,b=this._eventManager.ghostCtx;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=this.plotArea,n=0,m,k,h,r,q,p,g,e=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1,n=this.options.dataPointMaxWidth?
...
this.dataPointWidth:-Infinity,e));l<e&&(l=e);l>n&&(l=n);c.save();t&&b.save();c.beginPath();c.rect(f.x1,f.y1,f.width,f.height);c.clip();t&&(b.beginPath(),b.rect(f.x1,f.y1,f.width,f.height),b.clip());for(var fa=!1,fa=!!a.axisY.reversed,da=0;da<a.dataSeriesIndexes.length;da++){var u=a.dataSeriesIndexes[da],x=this.data[u],z=x.dataPoints;if(0<z.length)for(var v=5<l&&x.bevelEnabled?!0:!1,n=0;n<z.length;n++)if(z[n].getTime?g=z[n].x.getTime():g=z[n].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&
!s(z[n].y)&&z[n].y.length&&"number"===typeof z[n].y[0]&&"number"===typeof z[n].y[1]&&"number"===typeof z[n].y[2]&&"number"===typeof z[n].y[3]&&"number"===typeof z[n].y[4]&&5===z[n].y.length){m=a.axisX.convertValueToPixel(g);k=a.axisY.convertValueToPixel(z[n].y[0]);h=a.axisY.convertValueToPixel(z[n].y[1]);r=a.axisY.convertValueToPixel(z[n].y[2]);q=a.axisY.convertValueToPixel(z[n].y[3]);p=a.axisY.convertValueToPixel(z[n].y[4]);var y=m-l/2<<0,B=m+l/2<<0,e=z[n].color?z[n].color:x._colorSet[0],w=Math.round(Math.max(1,
0.15*l)),E=0===w%2?0:0.5,T=z[n].whiskerColor?z[n].whiskerColor:z[n].color?x.whiskerColor?x.whiskerColor:z[n].color:x.whiskerColor?x.whiskerColor:e,S="number"===typeof z[n].whiskerThickness?z[n].whiskerThickness:"number"===typeof x.options.whiskerThickness?x.whiskerThickness:w,F=z[n].whiskerDashType?z[n].whiskerDashType:x.whiskerDashType,Z=s(z[n].whiskerLength)?s(x.options.whiskerLength)?l:x.whiskerLength:z[n].whiskerLength,Z="number"===typeof Z?0>=Z?0:Z>=l?l:Z:"string"===typeof Z?parseInt(Z)*l/100>
l?l:parseInt(Z)*l/100:l,ga=1===Math.round(S)%2?0.5:0,ma=z[n].stemColor?z[n].stemColor:z[n].color?x.stemColor?x.stemColor:z[n].color:x.stemColor?x.stemColor:e,Ba="number"===typeof z[n].stemThickness?z[n].stemThickness:"number"===typeof x.options.stemThickness?x.stemThickness:w,G=1===Math.round(Ba)%2?0.5:0,J=z[n].stemDashType?z[n].stemDashType:x.stemDashType,I=z[n].lineColor?z[n].lineColor:z[n].color?x.lineColor?x.lineColor:z[n].color:x.lineColor?x.lineColor:e,L="number"===typeof z[n].lineThickness?
z[n].lineThickness:"number"===typeof x.options.lineThickness?x.lineThickness:w,R=z[n].lineDashType?z[n].lineDashType:x.lineDashType,K=1===Math.round(L)%2?0.5:0,P=x.upperBoxColor,xa=x.lowerBoxColor,sa=s(x.options.fillOpacity)?1:x.fillOpacity,O=x.dataPointIds[n];this._eventManager.objectMap[O]={id:O,objectType:"dataPoint",dataSeriesIndex:u,dataPointIndex:n,x1:y,y1:k,x2:B,y2:h,x3:m,y3:r,x4:m,y4:q,y5:p,borderThickness:w,color:e,stemThickness:Ba,stemColor:ma,whiskerThickness:S,whiskerLength:Z,whiskerColor:T,
lineThickness:L,lineColor:I};c.save();0<Ba&&(c.beginPath(),c.strokeStyle=ma,c.lineWidth=Ba,c.setLineDash&&c.setLineDash(N(J,Ba)),c.moveTo(m-G,h),c.lineTo(m-G,k),c.stroke(),c.moveTo(m-G,q),c.lineTo(m-G,r),c.stroke());c.restore();b.lineWidth=Math.max(w,4);c.beginPath();ba(c,y,Math.min(p,h),B,Math.max(h,p),xa,0,e,fa?v:!1,fa?!1:v,!1,!1,sa);c.beginPath();ba(c,y,Math.min(r,p),B,Math.max(p,r),P,0,e,fa?!1:v,fa?v:!1,!1,!1,sa);c.beginPath();c.lineWidth=w;c.strokeStyle=e;c.rect(y-E,Math.min(h,r)-E,B-y+2*E,Math.max(h,
r)-Math.min(h,r)+2*E);c.stroke();c.save();0<L&&(c.beginPath(),c.globalAlpha=1,c.setLineDash&&c.setLineDash(N(R,L)),c.strokeStyle=I,c.lineWidth=L,c.moveTo(y,p-K),c.lineTo(B,p-K),c.stroke());c.restore();c.save();0<S&&(c.beginPath(),c.setLineDash&&c.setLineDash(N(F,S)),c.strokeStyle=T,c.lineWidth=S,c.moveTo(m-Z/2<<0,q-ga),c.lineTo(m+Z/2<<0,q-ga),c.stroke(),c.moveTo(m-Z/2<<0,k+ga),c.lineTo(m+Z/2<<0,k+ga),c.stroke());c.restore();t&&(e=Q(O),b.strokeStyle=e,b.lineWidth=Ba,0<Ba&&(b.moveTo(m-E-G,h),b.lineTo(m-
E-G,Math.max(k,q)),b.stroke(),b.moveTo(m-E-G,Math.min(k,q)),b.lineTo(m-E-G,r),b.stroke()),ba(b,y,Math.max(h,r),B,Math.min(h,r),e,0,null,!1,!1,!1,!1),0<S&&(b.beginPath(),b.lineWidth=S,b.moveTo(m+Z/2,q-ga),b.lineTo(m-Z/2,q-ga),b.stroke(),b.moveTo(m+Z/2,k+ga),b.lineTo(m-Z/2,k+ga),b.stroke()));(z[n].indexLabel||x.indexLabel||z[n].indexLabelFormatter||x.indexLabelFormatter)&&this._indexLabels.push({chartType:x.type,dataPoint:z[n],dataSeries:x,point:{x:y+(B-y)/2,y:a.axisY.reversed?k:q},direction:1,bounds:{x1:y,
...
dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0}}};l.prototype.renderRangeColumn=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=t?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=0,n,m,k,f=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;n=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:
0.03*this.width;var h=a.axisX.dataInfo.minDiff;isFinite(h)||(h=0.3*Math.abs(a.axisX.range));h=this.options.dataPointWidth?this.dataPointWidth:0.9*(e.width*(a.axisX.logarithmic?Math.log(h)/Math.log(a.axisX.range):Math.abs(h)/Math.abs(a.axisX.range))/a.plotType.totalDataSeries)<<0;this.dataPointMaxWidth&&f>n&&(f=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,n));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&n<f)&&(n=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,
f));h<f&&(h=f);h>n&&(h=n);c.save();t&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();t&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var r=0;r<a.dataSeriesIndexes.length;r++){var q=a.dataSeriesIndexes[r],p=this.data[q],g=p.dataPoints;if(0<g.length)for(var l=5<h&&p.bevelEnabled?!0:!1,f=0;f<g.length;f++)if(g[f].getTime?k=g[f].x.getTime():k=g[f].x,!(k<a.axisX.dataInfo.viewPortMin||
k>a.axisX.dataInfo.viewPortMax)&&!s(g[f].y)&&g[f].y.length&&"number"===typeof g[f].y[0]&&"number"===typeof g[f].y[1]){b=a.axisX.convertValueToPixel(k);n=a.axisY.convertValueToPixel(g[f].y[0]);m=a.axisY.convertValueToPixel(g[f].y[1]);var fa=a.axisX.reversed?b+a.plotType.totalDataSeries*h/2-(a.previousDataSeriesCount+r)*h<<0:b-a.plotType.totalDataSeries*h/2+(a.previousDataSeriesCount+r)*h<<0,v=a.axisX.reversed?fa-h<<0:fa+h<<0,b=g[f].color?g[f].color:p._colorSet[f%p._colorSet.length];if(n>m){var u=n;
n=m;m=u}u=p.dataPointIds[f];this._eventManager.objectMap[u]={id:u,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:fa,y1:n,x2:v,y2:m};ba(c,fa,n,v,m,b,0,b,l,l,!1,!1,p.fillOpacity);b=Q(u);t&&ba(this._eventManager.ghostCtx,fa,n,v,m,b,0,null,!1,!1,!1,!1);if(g[f].indexLabel||p.indexLabel||g[f].indexLabelFormatter||p.indexLabelFormatter)this._indexLabels.push({chartType:"rangeColumn",dataPoint:g[f],dataSeries:p,indexKeyword:0,point:{x:fa+(v-fa)/2,y:g[f].y[1]>=g[f].y[0]?m:n},direction:g[f].y[1]>=
g[f].y[0]?-1:1,bounds:{x1:fa,y1:Math.min(n,m),x2:v,y2:Math.max(n,m)},color:b}),this._indexLabels.push({chartType:"rangeColumn",dataPoint:g[f],dataSeries:p,indexKeyword:1,point:{x:fa+(v-fa)/2,y:g[f].y[1]>=g[f].y[0]?n:m},direction:g[f].y[1]>=g[f].y[0]?1:-1,bounds:{x1:fa,y1:Math.min(n,m),x2:v,y2:Math.max(n,m)},color:b})}}t&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),
a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0}}};l.prototype.renderError=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=t?this._preRenderCtx:
...
0,u=0;u<this.data.length;u++)!this.data[u].type.match(/(bar|column)/ig)||!this.data[u].visible||this.data[u].type.match(/(stacked)/ig)&&v||v++;for(var x=0;x<a.dataSeriesIndexes.length;x++){var z=a.dataSeriesIndexes[x],D=this.data[z],y=D.dataPoints,B=s(D._linkedSeries)?!1:D._linkedSeries.type.match(/(bar|column)/ig)&&D._linkedSeries.visible?!0:!1,E=0;if(B)for(e=D._linkedSeries.id,u=0;u<e;u++)!this.data[u].type.match(/(bar|column)/ig)||!this.data[u].visible||this.data[u].type.match(/(stacked)/ig)&&
E||(this.data[u].type.match(/(range)/ig)&&(f=!0),E++);e=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;m=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:b?Math.min(0.15*this.height,0.9*(this.plotArea.height/(B?v:1)))<<0:0.3*this.width;f&&(m=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:b?Math.min(0.15*this.height,0.9*(this.plotArea.height/
(B?v:1)))<<0:0.03*this.width);u=this.options.dataPointWidth?this.dataPointWidth:0.9*((b?n.height:n.width)*(a.axisX.logarithmic?Math.log(fa)/Math.log(a.axisX.range):Math.abs(fa)/Math.abs(a.axisX.range))/(B?v:1))<<0;this.dataPointMaxWidth&&e>m&&(e=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,m));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&m<e)&&(m=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,e));u<e&&(u=e);u>m&&(u=m);if(0<y.length)for(var F=D._colorSet,
m=0;m<y.length;m++){var e=D.lineColor=D.options.color?D.options.color:F[0],T={color:y[m].whiskerColor?y[m].whiskerColor:y[m].color?D.whiskerColor?D.whiskerColor:y[m].color:D.whiskerColor?D.whiskerColor:e,thickness:s(y[m].whiskerThickness)?D.whiskerThickness:y[m].whiskerThickness,dashType:y[m].whiskerDashType?y[m].whiskerDashType:D.whiskerDashType,length:s(y[m].whiskerLength)?s(D.options.whiskerLength)?u:D.options.whiskerLength:y[m].whiskerLength,trimLength:s(y[m].whiskerLength)?s(D.options.whiskerLength)?
50:0:0};T.length="number"===typeof T.length?0>=T.length?0:T.length>=u?u:T.length:"string"===typeof T.length?parseInt(T.length)*u/100>u?u:parseInt(T.length)*u/100>u:u;T.thickness="number"===typeof T.thickness?0>T.thickness?0:Math.round(T.thickness):2;var S={color:y[m].stemColor?y[m].stemColor:y[m].color?D.stemColor?D.stemColor:y[m].color:D.stemColor?D.stemColor:e,thickness:y[m].stemThickness?y[m].stemThickness:D.stemThickness,dashType:y[m].stemDashType?y[m].stemDashType:D.stemDashType};S.thickness=
"number"===typeof S.thickness?0>S.thickness?0:Math.round(S.thickness):2;y[m].getTime?l=y[m].x.getTime():l=y[m].x;if(!(l<a.axisX.dataInfo.viewPortMin||l>a.axisX.dataInfo.viewPortMax)&&!s(y[m].y)&&y[m].y.length&&"number"===typeof y[m].y[0]&&"number"===typeof y[m].y[1]){var ka=a.axisX.convertValueToPixel(l);b?h=ka:k=ka;ka=a.axisY.convertValueToPixel(y[m].y[0]);b?r=ka:p=ka;ka=a.axisY.convertValueToPixel(y[m].y[1]);b?q=ka:g=ka;b?(p=a.axisX.reversed?h+(B?v:1)*u/2-(B?E-1:0)*u<<0:h-(B?v:1)*u/2+(B?E-1:0)*
u<<0,g=a.axisX.reversed?p-u<<0:p+u<<0):(r=a.axisX.reversed?k+(B?v:1)*u/2-(B?E-1:0)*u<<0:k-(B?v:1)*u/2+(B?E-1:0)*u<<0,q=a.axisX.reversed?r-u<<0:r+u<<0);!b&&p>g&&(ka=p,p=g,g=ka);b&&r>q&&(ka=r,r=q,q=ka);ka=D.dataPointIds[m];this._eventManager.objectMap[ka]={id:ka,objectType:"dataPoint",dataSeriesIndex:z,dataPointIndex:m,x1:Math.min(r,q),y1:Math.min(p,g),x2:Math.max(q,r),y2:Math.max(g,p),isXYSwapped:b,stemProperties:S,whiskerProperties:T};w(c,Math.min(r,q),Math.min(p,g),Math.max(q,r),Math.max(g,p),e,
T,S,b);t&&w(this._eventManager.ghostCtx,r,p,q,g,e,T,S,b);if(y[m].indexLabel||D.indexLabel||y[m].indexLabelFormatter||D.indexLabelFormatter)this._indexLabels.push({chartType:"error",dataPoint:y[m],dataSeries:D,indexKeyword:0,point:{x:b?y[m].y[1]>=y[m].y[0]?r:q:r+(q-r)/2,y:b?p+(g-p)/2:y[m].y[1]>=y[m].y[0]?g:p},direction:y[m].y[1]>=y[m].y[0]?-1:1,bounds:{x1:b?Math.min(r,q):r,y1:b?p:Math.min(p,g),x2:b?Math.max(r,q):q,y2:b?g:Math.max(p,g)},color:e,axisSwapped:b}),this._indexLabels.push({chartType:"error",
dataPoint:y[m],dataSeries:D,indexKeyword:1,point:{x:b?y[m].y[1]>=y[m].y[0]?q:r:r+(q-r)/2,y:b?p+(g-p)/2:y[m].y[1]>=y[m].y[0]?p:g},direction:y[m].y[1]>=y[m].y[0]?1:-1,bounds:{x1:b?Math.min(r,q):r,y1:b?p:Math.min(p,g),x2:b?Math.max(r,q):q,y2:b?g:Math.max(p,g)},color:e,axisSwapped:b})}}}t&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,
0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(n.x1,n.y1,n.width,n.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0}}};l.prototype.renderRangeBar=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=t?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=
null,e=this.plotArea,f=0,n,m,k,h,f=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;n=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:Math.min(0.15*this.height,0.9*(this.plotArea.height/a.plotType.totalDataSeries))<<0;var r=a.axisX.dataInfo.minDiff;isFinite(r)||(r=0.3*Math.abs(a.axisX.range));r=this.options.dataPointWidth?this.dataPointWidth:0.9*(e.height*(a.axisX.logarithmic?Math.log(r)/Math.log(a.axisX.range):
...
e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var q=0;q<a.dataSeriesIndexes.length;q++){var p=a.dataSeriesIndexes[q],g=this.data[p],l=g.dataPoints;if(0<l.length){var fa=5<r&&g.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(f=0;f<l.length;f++)if(l[f].getTime?h=l[f].x.getTime():h=l[f].x,!(h<a.axisX.dataInfo.viewPortMin||h>a.axisX.dataInfo.viewPortMax)&&!s(l[f].y)&&l[f].y.length&&"number"===typeof l[f].y[0]&&"number"===typeof l[f].y[1]){n=a.axisY.convertValueToPixel(l[f].y[0]);m=a.axisY.convertValueToPixel(l[f].y[1]);
k=a.axisX.convertValueToPixel(h);k=a.axisX.reversed?k+a.plotType.totalDataSeries*r/2-(a.previousDataSeriesCount+q)*r<<0:k-a.plotType.totalDataSeries*r/2+(a.previousDataSeriesCount+q)*r<<0;var v=a.axisX.reversed?k-r<<0:k+r<<0;n>m&&(b=n,n=m,m=b);b=l[f].color?l[f].color:g._colorSet[f%g._colorSet.length];ba(c,n,k,m,v,b,0,null,fa,!1,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:p,dataPointIndex:f,x1:n,y1:k,x2:m,y2:v};b=Q(b);t&&ba(this._eventManager.ghostCtx,
n,k,m,v,b,0,null,!1,!1,!1,!1);if(l[f].indexLabel||g.indexLabel||l[f].indexLabelFormatter||g.indexLabelFormatter)this._indexLabels.push({chartType:"rangeBar",dataPoint:l[f],dataSeries:g,indexKeyword:0,point:{x:l[f].y[1]>=l[f].y[0]?n:m,y:k+(v-k)/2},direction:l[f].y[1]>=l[f].y[0]?-1:1,bounds:{x1:Math.min(n,m),y1:k,x2:Math.max(n,m),y2:v},color:b}),this._indexLabels.push({chartType:"rangeBar",dataPoint:l[f],dataSeries:g,indexKeyword:1,point:{x:l[f].y[1]>=l[f].y[0]?m:n,y:k+(v-k)/2},direction:l[f].y[1]>=
l[f].y[0]?1:-1,bounds:{x1:Math.min(n,m),y1:k,x2:Math.max(n,m),y2:v},color:b})}}}t&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());
c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0}}};l.prototype.renderRangeArea=function(a){function d(){if(x){var a=null;0<r.lineThickness&&b.stroke();for(var c=k.length-1;0<=c;c--)a=k[c],b.lineTo(a.x,a.y),e.lineTo(a.x,a.y);b.closePath();b.globalAlpha=r.fillOpacity;b.fill();b.globalAlpha=1;e.fill();if(0<r.lineThickness){b.beginPath();b.moveTo(a.x,a.y);for(c=0;c<k.length;c++)a=k[c],b.lineTo(a.x,a.y);b.stroke()}b.beginPath();
b.moveTo(l,s);e.beginPath();e.moveTo(l,s);x={x:l,y:s};k=[];k.push({x:l,y:v})}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=t?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=[],n=this.plotArea;b.save();t&&e.save();b.beginPath();b.rect(n.x1,n.y1,n.width,n.height);b.clip();t&&(e.beginPath(),e.rect(n.x1,n.y1,n.width,n.height),e.clip());for(var m=0;m<a.dataSeriesIndexes.length;m++){var k=[],h=a.dataSeriesIndexes[m],r=this.data[h],q=r.dataPoints,f=r.id;this._eventManager.objectMap[f]=
{objectType:"dataSeries",dataSeriesIndex:h};f=Q(f);e.fillStyle=f;var f=[],p=!0,g=0,l,s,v,u,x=null;if(0<q.length){var z=r._colorSet[g%r._colorSet.length],D=r.lineColor=r.options.lineColor||z,y=D;b.fillStyle=z;b.strokeStyle=D;b.lineWidth=r.lineThickness;var B="solid";if(b.setLineDash){var w=N(r.nullDataLineDashType,r.lineThickness),B=r.lineDashType,E=N(B,r.lineThickness);b.setLineDash(E)}for(var T=!0;g<q.length;g++)if(u=q[g].x.getTime?q[g].x.getTime():q[g].x,!(u<a.axisX.dataInfo.viewPortMin||u>a.axisX.dataInfo.viewPortMax&&
(!r.connectNullData||!T)))if(null!==q[g].y&&q[g].y.length&&"number"===typeof q[g].y[0]&&"number"===typeof q[g].y[1]){l=a.axisX.convertValueToPixel(u);s=a.axisY.convertValueToPixel(q[g].y[0]);v=a.axisY.convertValueToPixel(q[g].y[1]);p||T?(r.connectNullData&&!p?(b.setLineDash&&(r.options.nullDataLineDashType||B===r.lineDashType&&r.lineDashType!==r.nullDataLineDashType)&&(k[k.length-1].newLineDashArray=E,B=r.nullDataLineDashType,b.setLineDash(w)),b.lineTo(l,s),t&&e.lineTo(l,s),k.push({x:l,y:v})):(b.beginPath(),
b.moveTo(l,s),x={x:l,y:s},k=[],k.push({x:l,y:v}),t&&(e.beginPath(),e.moveTo(l,s))),T=p=!1):(b.lineTo(l,s),k.push({x:l,y:v}),t&&e.lineTo(l,s),0==g%250&&d());u=r.dataPointIds[g];this._eventManager.objectMap[u]={id:u,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:g,x1:l,y1:s,y2:v};g<q.length-1&&(y!==(q[g].lineColor||D)||B!==(q[g].lineDashType||r.lineDashType))&&(d(),y=q[g].lineColor||D,k[k.length-1].newStrokeStyle=y,b.strokeStyle=y,b.setLineDash&&(q[g].lineDashType?(B=q[g].lineDashType,k[k.length-
1].newLineDashArray=N(B,r.lineThickness),b.setLineDash(k[k.length-1].newLineDashArray)):(B=r.lineDashType,k[k.length-1].newLineDashArray=E,b.setLineDash(E))));if(0!==q[g].markerSize&&(0<q[g].markerSize||0<r.markerSize)){var S=r.getMarkerProperties(g,l,v,b);f.push(S);var F=Q(u);t&&f.push({x:l,y:v,ctx:e,type:S.type,size:S.size,color:F,borderColor:F,borderThickness:S.borderThickness});S=r.getMarkerProperties(g,l,s,b);f.push(S);F=Q(u);t&&f.push({x:l,y:s,ctx:e,type:S.type,size:S.size,color:F,borderColor:F,
borderThickness:S.borderThickness})}if(q[g].indexLabel||r.indexLabel||q[g].indexLabelFormatter||r.indexLabelFormatter)this._indexLabels.push({chartType:"rangeArea",dataPoint:q[g],dataSeries:r,indexKeyword:0,point:{x:l,y:s},direction:q[g].y[0]>q[g].y[1]===a.axisY.reversed?-1:1,color:z}),this._indexLabels.push({chartType:"rangeArea",dataPoint:q[g],dataSeries:r,indexKeyword:1,point:{x:l,y:v},direction:q[g].y[0]>q[g].y[1]===a.axisY.reversed?1:-1,color:z})}else T||p||d(),T=!0;d();W.drawMarkers(f)}}t&&
(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(n.x1,n.y1,n.width,n.height),this._eventManager.ghostCtx.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,
easingFunction:M.easing.linear,animationBase:0}}};l.prototype.renderRangeSplineArea=function(a){function d(a,c){var d=v(s,2);if(0<d.length){if(0<h.lineThickness){b.strokeStyle=c;b.setLineDash&&b.setLineDash(a);b.beginPath();b.moveTo(d[0].x,d[0].y);for(var f=0;f<d.length-3;f+=3){if(d[f].newStrokeStyle||d[f].newLineDashArray)b.stroke(),b.beginPath(),b.moveTo(d[f].x,d[f].y),d[f].newStrokeStyle&&(b.strokeStyle=d[f].newStrokeStyle),d[f].newLineDashArray&&b.setLineDash(d[f].newLineDashArray);b.bezierCurveTo(d[f+
1].x,d[f+1].y,d[f+2].x,d[f+2].y,d[f+3].x,d[f+3].y)}b.stroke()}b.beginPath();b.moveTo(d[0].x,d[0].y);t&&(e.beginPath(),e.moveTo(d[0].x,d[0].y));for(f=0;f<d.length-3;f+=3)b.bezierCurveTo(d[f+1].x,d[f+1].y,d[f+2].x,d[f+2].y,d[f+3].x,d[f+3].y),t&&e.bezierCurveTo(d[f+1].x,d[f+1].y,d[f+2].x,d[f+2].y,d[f+3].x,d[f+3].y);d=v(da,2);b.lineTo(da[da.length-1].x,da[da.length-1].y);for(f=d.length-1;2<f;f-=3)b.bezierCurveTo(d[f-1].x,d[f-1].y,d[f-2].x,d[f-2].y,d[f-3].x,d[f-3].y),t&&e.bezierCurveTo(d[f-1].x,d[f-1].y,
d[f-2].x,d[f-2].y,d[f-3].x,d[f-3].y);b.closePath();b.globalAlpha=h.fillOpacity;b.fill();t&&(e.closePath(),e.fill());b.globalAlpha=1;if(0<h.lineThickness){b.strokeStyle=c;b.setLineDash&&b.setLineDash(a);b.beginPath();b.moveTo(d[0].x,d[0].y);for(var g=f=0;f<d.length-3;f+=3,g++){if(s[g].newStrokeStyle||s[g].newLineDashArray)b.stroke(),b.beginPath(),b.moveTo(d[f].x,d[f].y),s[g].newStrokeStyle&&(b.strokeStyle=s[g].newStrokeStyle),s[g].newLineDashArray&&b.setLineDash(s[g].newLineDashArray);b.bezierCurveTo(d[f+
1].x,d[f+1].y,d[f+2].x,d[f+2].y,d[f+3].x,d[f+3].y)}b.stroke()}b.beginPath()}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=t?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=[],n=this.plotArea;b.save();t&&e.save();b.beginPath();b.rect(n.x1,n.y1,n.width,n.height);b.clip();t&&(e.beginPath(),e.rect(n.x1,n.y1,n.width,n.height),e.clip());for(var m=0;m<a.dataSeriesIndexes.length;m++){var k=a.dataSeriesIndexes[m],h=this.data[k],r=h.dataPoints,f=h.id;this._eventManager.objectMap[f]=
{objectType:"dataSeries",dataSeriesIndex:k};f=Q(f);e.fillStyle=f;var f=[],q=0,p,g,l,s=[],da=[];if(0<r.length){var u=h._colorSet[q%h._colorSet.length],x=h.lineColor=h.options.lineColor||u,z=x;b.fillStyle=u;b.lineWidth=h.lineThickness;var D="solid",y;if(b.setLineDash){var B=N(h.nullDataLineDashType,h.lineThickness),D=h.lineDashType;y=N(D,h.lineThickness)}for(g=!1;q<r.length;q++)if(p=r[q].x.getTime?r[q].x.getTime():r[q].x,!(p<a.axisX.dataInfo.viewPortMin||p>a.axisX.dataInfo.viewPortMax&&(!h.connectNullData||
!g)))if(null!==r[q].y&&r[q].y.length&&"number"===typeof r[q].y[0]&&"number"===typeof r[q].y[1]){p=a.axisX.convertValueToPixel(p);g=a.axisY.convertValueToPixel(r[q].y[0]);l=a.axisY.convertValueToPixel(r[q].y[1]);var w=h.dataPointIds[q];this._eventManager.objectMap[w]={id:w,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:q,x1:p,y1:g,y2:l};s[s.length]={x:p,y:g};da[da.length]={x:p,y:l};q<r.length-1&&(z!==(r[q].lineColor||x)||D!==(r[q].lineDashType||h.lineDashType))&&(z=r[q].lineColor||x,s[s.length-
1].newStrokeStyle=z,b.setLineDash&&(r[q].lineDashType?(D=r[q].lineDashType,s[s.length-1].newLineDashArray=N(D,h.lineThickness)):(D=h.lineDashType,s[s.length-1].newLineDashArray=y)));if(0!==r[q].markerSize&&(0<r[q].markerSize||0<h.markerSize)){var E=h.getMarkerProperties(q,p,g,b);f.push(E);var T=Q(w);t&&f.push({x:p,y:g,ctx:e,type:E.type,size:E.size,color:T,borderColor:T,borderThickness:E.borderThickness});E=h.getMarkerProperties(q,p,l,b);f.push(E);T=Q(w);t&&f.push({x:p,y:l,ctx:e,type:E.type,size:E.size,
color:T,borderColor:T,borderThickness:E.borderThickness})}if(r[q].indexLabel||h.indexLabel||r[q].indexLabelFormatter||h.indexLabelFormatter)this._indexLabels.push({chartType:"rangeSplineArea",dataPoint:r[q],dataSeries:h,indexKeyword:0,point:{x:p,y:g},direction:r[q].y[0]<=r[q].y[1]?-1:1,color:u}),this._indexLabels.push({chartType:"rangeSplineArea",dataPoint:r[q],dataSeries:h,indexKeyword:1,point:{x:p,y:l},direction:r[q].y[0]<=r[q].y[1]?1:-1,color:u});g=!1}else 0<q&&!g&&(h.connectNullData?b.setLineDash&&
(0<s.length&&(h.options.nullDataLineDashType||!r[q-1].lineDashType))&&(s[s.length-1].newLineDashArray=B,D=h.nullDataLineDashType):(d(y,x),s=[],da=[])),g=!0;d(y,x);W.drawMarkers(f)}}t&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
0,0,this.width,this.height),b.clearRect(n.x1,n.y1,n.width,n.height),this._eventManager.ghostCtx.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};l.prototype.renderWaterfall=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=t?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this._eventManager.ghostCtx,e=null,f=this.plotArea,n=0,m,k,h,r,q=a.axisY.convertValueToPixel(a.axisY.logarithmic?
...
f.y1,f.width,f.height),this._eventManager.ghostCtx.clip());for(var g=0;g<a.dataSeriesIndexes.length;g++){var l=a.dataSeriesIndexes[g],s=this.data[l],v=s.dataPoints,e=s._colorSet[0];s.risingColor=s.options.risingColor?s.options.risingColor:e;s.fallingColor=s.options.fallingColor?s.options.fallingColor:"#e40a0a";var u="number"===typeof s.options.lineThickness?Math.round(s.lineThickness):1,x=1===Math.round(u)%2?-0.5:0;if(0<v.length)for(var z=5<p&&s.bevelEnabled?!0:!1,D=!1,y=null,B=null,n=0;n<v.length;n++)if(v[n].getTime?
r=v[n].x.getTime():r=v[n].x,"number"!==typeof v[n].y){if(0<n&&!D&&s.connectNullData)var w=s.options.nullDataLineDashType||!v[n-1].lineDashType?s.nullDataLineDashType:v[n-1].lineDashType;D=!0}else{m=a.axisX.convertValueToPixel(r);k=0===s.dataPointEOs[n].cumulativeSum?q:a.axisY.convertValueToPixel(s.dataPointEOs[n].cumulativeSum);h=0===s.dataPointEOs[n].cumulativeSumYStartValue?q:a.axisY.convertValueToPixel(s.dataPointEOs[n].cumulativeSumYStartValue);m=a.axisX.reversed?m+a.plotType.totalDataSeries*
p/2-(a.previousDataSeriesCount+g)*p<<0:m-a.plotType.totalDataSeries*p/2+(a.previousDataSeriesCount+g)*p<<0;var E=a.axisX.reversed?m-p<<0:m+p<<0;k>h&&(e=k,k=h,h=e);a.axisY.reversed&&(e=k,k=h,h=e);e=s.dataPointIds[n];this._eventManager.objectMap[e]={id:e,objectType:"dataPoint",dataSeriesIndex:l,dataPointIndex:n,x1:m,y1:k,x2:E,y2:h};var T=v[n].color?v[n].color:0<v[n].y?s.risingColor:s.fallingColor;ba(c,m,k,E,h,T,0,T,z,z,!1,!1,s.fillOpacity);e=Q(e);t&&ba(this._eventManager.ghostCtx,m,k,E,h,e,0,null,!1,
!1,!1,!1);var S,T=m;S="undefined"!==typeof v[n].isIntermediateSum&&!0===v[n].isIntermediateSum||"undefined"!==typeof v[n].isCumulativeSum&&!0===v[n].isCumulativeSum?0<v[n].y?k:h:0<v[n].y?h:k;0<n&&y&&(!D||s.connectNullData)&&(D&&c.setLineDash&&c.setLineDash(N(w,u)),c.beginPath(),c.moveTo(y,B-x),c.lineTo(T,S-x),0<u&&c.stroke(),t&&(b.beginPath(),b.moveTo(y,B-x),b.lineTo(T,S-x),0<u&&b.stroke()));D=!1;y=E;B=0<v[n].y?k:h;T=v[n].lineDashType?v[n].lineDashType:s.options.lineDashType?s.options.lineDashType:
...
2)-Math.pow(c-z.y,2)):z.x-Math.sqrt(Math.pow(t,2)-Math.pow(c-z.y,2));q=z.x+B*Math.cos(k.midAngle);p=z.y+B*Math.sin(k.midAngle);p=Math.sqrt(Math.pow(m-q,2)+Math.pow(c-p,2));q=Math.acos(B/t);p=Math.acos((t*t+B*B-p*p)/(2*B*t));c=p<q?c-k.indexLabelTextBlock.y:0;m=null;for(n=1;n<r.length;n++)if(m=(a-n+g.length)%g.length,g[m].hemisphere!==g[a].hemisphere){m=null;break}else if(g[m].indexLabelText&&g[m].hemisphere===g[a].hemisphere&&m!==a&&(0>b(g[m],g[a])||("right"===g[a].hemisphere?g[m].indexLabelTextBlock.y<=
g[a].indexLabelTextBlock.y:g[m].indexLabelTextBlock.y>=g[a].indexLabelTextBlock.y)))break;else m=null;q=m;p=e(a);n=m=0;0>c?(n="right"===k.hemisphere?q:p,h=c,null!==n&&(q=-c,c=k.indexLabelTextBlock.y-k.indexLabelTextBlock.height/2-(g[n].indexLabelTextBlock.y+g[n].indexLabelTextBlock.height/2),c-q<l&&(m=-q,n=f(n,m,d+1),+n.toFixed(x)>+m.toFixed(x)&&(h=c>l?-(c-l):-(q-(n-m)))))):0<c&&(n="right"===k.hemisphere?p:q,h=c,null!==n&&(q=c,c=g[n].indexLabelTextBlock.y-g[n].indexLabelTextBlock.height/2-(k.indexLabelTextBlock.y+
k.indexLabelTextBlock.height/2),c-q<l&&(m=q,n=f(n,m,d+1),+n.toFixed(x)<+m.toFixed(x)&&(h=c>l?c-l:q-(m-n)))));h&&(d=k.indexLabelTextBlock.y+h,c=0,c="right"===k.hemisphere?z.x+Math.sqrt(Math.pow(t,2)-Math.pow(d-z.y,2)):z.x-Math.sqrt(Math.pow(t,2)-Math.pow(d-z.y,2)),k.midAngle>Math.PI/2-u&&k.midAngle<Math.PI/2+u?(m=(a-1+g.length)%g.length,m=g[m],a=g[(a+1+g.length)%g.length],"left"===k.hemisphere&&"right"===m.hemisphere&&c>m.indexLabelTextBlock.x?c=m.indexLabelTextBlock.x-15:"right"===k.hemisphere&&("left"===
a.hemisphere&&c<a.indexLabelTextBlock.x)&&(c=a.indexLabelTextBlock.x+15)):k.midAngle>3*Math.PI/2-u&&k.midAngle<3*Math.PI/2+u&&(m=(a-1+g.length)%g.length,m=g[m],a=g[(a+1+g.length)%g.length],"right"===k.hemisphere&&"left"===m.hemisphere&&c<m.indexLabelTextBlock.x?c=m.indexLabelTextBlock.x+15:"left"===k.hemisphere&&("right"===a.hemisphere&&c>a.indexLabelTextBlock.x)&&(c=a.indexLabelTextBlock.x-15)),k.indexLabelTextBlock.y=d,k.indexLabelTextBlock.x=c,k.indexLabelAngle=Math.atan2(k.indexLabelTextBlock.y-
...
typeof x[h].y)return-1;x[h].y="number"===typeof x[h].y?x[h].y:0;g+=Math.abs(x[h].y)}if(0===g)return-1;for(var n=d[0]=0,m=0,k,r,b=b-a,n=!1,h=0;h<x.length;h++)a=Math.abs(x[h].y)*f/g,n?k=0==Number(c.toFixed(3))?0:a/c:(r=aa*aa*b*b-4*Math.abs(aa)*a,0>r?(r=c,n=(b+r)*(e-m)/2,a-=n,k=e-m,m+=e-m,k+=0==r?0:a/r,m+=a/r,n=!0):(k=(Math.abs(aa)*b-Math.sqrt(r))/2,r=b-2*k/Math.abs(aa),m+=k,m>e&&(m-=k,r=c,n=(b+r)*(e-m)/2,a-=n,k=e-m,m+=e-m,k+=a/r,m+=a/r,n=!0),b=r)),d.push(k);return d}function b(){if(u&&x){for(var a,
b,c,d,e,f,h,m,n,k,r,p,q,l,A=[],C=[],v={percent:null,total:null},z=null,y=0;y<x.length;y++)l=O[y],l="undefined"!==typeof l.x5?(l.y2+l.y4)/2:(l.y2+l.y3)/2,l=g(l).x2+1,A[y]=L-l-V;l=0.5*V;for(var y=0,B=x.length-1;y<x.length||0<=B;y++,B--){b=u.reversed?x[B]:x[y];a=b.color?b.color:u.reversed?u._colorSet[(x.length-1-y)%u._colorSet.length]:u._colorSet[y%u._colorSet.length];c=b.indexLabelPlacement||u.indexLabelPlacement||"outside";d=b.indexLabelBackgroundColor||u.indexLabelBackgroundColor||(t?"transparent":
null);e=b.indexLabelFontColor||u.indexLabelFontColor||"#979797";f=s(b.indexLabelFontSize)?u.indexLabelFontSize:b.indexLabelFontSize;h=b.indexLabelFontStyle||u.indexLabelFontStyle||"normal";m=b.indexLabelFontFamily||u.indexLabelFontFamily||"arial";n=b.indexLabelFontWeight||u.indexLabelFontWeight||"normal";a=b.indexLabelLineColor||u.options.indexLabelLineColor||a;k="number"===typeof b.indexLabelLineThickness?b.indexLabelLineThickness:"number"===typeof u.indexLabelLineThickness?u.indexLabelLineThickness:
2;r=b.indexLabelLineDashType||u.indexLabelLineDashType||"solid";p="undefined"!==typeof b.indexLabelWrap?b.indexLabelWrap:"undefined"!==typeof u.indexLabelWrap?u.indexLabelWrap:!0;q=u.dataPointIds[y];w._eventManager.objectMap[q]={id:q,objectType:"dataPoint",dataPointIndex:y,dataSeriesIndex:0,funnelSection:O[u.reversed?x.length-1-y:y]};"inside"===u.indexLabelPlacement&&(A[y]=y!==ba?u.reversed?O[y].x2-O[y].x1:O[y].x3-O[y].x4:O[y].x3-O[y].x6,20>A[y]&&(A[y]=y!==ba?u.reversed?O[y].x3-O[y].x4:O[y].x2-O[y].x1:
O[y].x2-O[y].x1,A[y]/=2));q=b.indexLabelMaxWidth?b.indexLabelMaxWidth:u.options.indexLabelMaxWidth?u.indexLabelMaxWidth:A[y];if(q>A[y]||0>q)q=A[y];C[y]="inside"===u.indexLabelPlacement?O[y].height:!1;v=w.getPercentAndTotal(u,b);if(u.indexLabelFormatter||b.indexLabelFormatter)z={chart:w.options,dataSeries:u,dataPoint:b,total:v.total,percent:v.percent};b=b.indexLabelFormatter?b.indexLabelFormatter(z):b.indexLabel?w.replaceKeywordsWithValue(b.indexLabel,b,u,y):u.indexLabelFormatter?u.indexLabelFormatter(z):
u.indexLabel?w.replaceKeywordsWithValue(u.indexLabel,b,u,y):b.label?b.label:"";0>=k&&(k=0);1E3>q&&1E3-q<l&&(q+=1E3-q);Q.roundRect||Ca(Q);c=new ja(Q,{fontSize:f,fontFamily:m,fontColor:e,fontStyle:h,fontWeight:n,horizontalAlign:c,backgroundColor:d,maxWidth:q,maxHeight:!1===C[y]?p?4.28571429*f:1.5*f:C[y],text:b,padding:ca});c.measureText();H.push({textBlock:c,id:u.reversed?B:y,isDirty:!1,lineColor:a,lineThickness:k,lineDashType:r,height:c.height<c.maxHeight?c.height:c.maxHeight,width:c.width<c.maxWidth?
c.width:c.maxWidth})}}}function e(){var a,b,c,d,e,f=[];e=!1;c=0;for(var g,h=L-$-V/2,h=u.options.indexLabelMaxWidth?u.indexLabelMaxWidth>h?h:u.indexLabelMaxWidth:h,m=H.length-1;0<=m;m--){g=x[H[m].id];c=H[m];d=c.textBlock;b=(a=p(m)<O.length?H[p(m)]:null)?a.textBlock:null;c=c.height;a&&d.y+c+ca>b.y&&(e=!0);c=g.indexLabelMaxWidth||h;if(c>h||0>c)c=h;f.push(c)}if(e)for(m=H.length-1;0<=m;m--)a=O[m],H[m].textBlock.maxWidth=f[f.length-(m+1)],H[m].textBlock.measureText(),H[m].textBlock.x=L-h,c=H[m].textBlock.height<
H[m].textBlock.maxHeight?H[m].textBlock.height:H[m].textBlock.maxHeight,e=H[m].textBlock.width<H[m].textBlock.maxWidth?H[m].textBlock.width:H[m].textBlock.maxWidth,H[m].height=c,H[m].width=e,c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/2,H[m].textBlock.y=c-H[m].height/2,u.reversed?(H[m].textBlock.y+H[m].height>na+D&&(H[m].textBlock.y=na+D-H[m].height),H[m].textBlock.y<sa-D&&(H[m].textBlock.y=sa-D)):(H[m].textBlock.y<na-D&&(H[m].textBlock.y=na-D),H[m].textBlock.y+H[m].height>sa+D&&(H[m].textBlock.y=
sa+D-H[m].height))}function f(){var a,b,c,d;if("inside"!==u.indexLabelPlacement)for(var e=0;e<O.length;e++)0==H[e].textBlock.text.length?H[e].isDirty=!0:(a=O[e],c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/2,b=u.reversed?"undefined"!==typeof a.x5?c>xa?g(c).x2+1:(a.x2+a.x3)/2+1:(a.x2+a.x3)/2+1:"undefined"!==typeof a.x5?c<xa?g(c).x2+1:(a.x4+a.x3)/2+1:(a.x2+a.x3)/2+1,H[e].textBlock.x=b+V,H[e].textBlock.y=c-H[e].height/2,u.reversed?(H[e].textBlock.y+H[e].height>na+D&&(H[e].textBlock.y=na+D-H[e].height),
H[e].textBlock.y<sa-D&&(H[e].textBlock.y=sa-D)):(H[e].textBlock.y<na-D&&(H[e].textBlock.y=na-D),H[e].textBlock.y+H[e].height>sa+D&&(H[e].textBlock.y=sa+D-H[e].height)));else for(e=0;e<O.length;e++)0==H[e].textBlock.text.length?H[e].isDirty=!0:(a=O[e],b=a.height,c=H[e].height,d=H[e].width,b>=c?(b=e!=ba?(a.x4+a.x3)/2-d/2:(a.x5+a.x4)/2-d/2,c=e!=ba?(a.y1+a.y3)/2-c/2:(a.y1+a.y4)/2-c/2,H[e].textBlock.x=b,H[e].textBlock.y=c):H[e].isDirty=!0)}function n(){function a(b,c){var d;if(0>b||b>=H.length)return 0;
var e,f=H[b].textBlock;if(0>c){c*=-1;e=q(b);d=m(e,b);if(d>=c)return f.y-=c,c;if(0==b)return 0<d&&(f.y-=d),d;d+=a(e,-(c-d));0<d&&(f.y-=d);return d}e=p(b);d=m(b,e);if(d>=c)return f.y+=c,c;if(b==O.length-1)return 0<d&&(f.y+=d),d;d+=a(e,c-d);0<d&&(f.y+=d);return d}function b(){var a,d,e,f,g=0,h;f=(R-Z+2*D)/k;h=k;for(var m,n=1;n<h;n++){e=n*f;for(var r=H.length-1;0<=r;r--)!H[r].isDirty&&(H[r].textBlock.y<e&&H[r].textBlock.y+H[r].height>e)&&(m=p(r),!(m>=H.length-1)&&H[r].textBlock.y+H[r].height+ca>H[m].textBlock.y&&
(H[r].textBlock.y=H[r].textBlock.y+H[r].height-e>e-H[r].textBlock.y?e+1:e-H[r].height-1))}for(m=O.length-1;0<m;m--)if(!H[m].isDirty){e=q(m);if(0>e&&(e=0,H[e].isDirty))break;if(H[m].textBlock.y<H[e].textBlock.y+H[e].height){d=d||m;f=m;for(h=0;H[f].textBlock.y<H[e].textBlock.y+H[e].height+ca;){a=a||H[f].textBlock.y+H[f].height;h+=H[f].height;h+=ca;f=e;if(0>=f){f=0;h+=H[f].height;break}e=q(f);if(0>e){f=0;h+=H[f].height;break}}if(f!=m){g=H[f].textBlock.y;a-=g;a=h-a;g=c(a,d,f);break}}}return g}function c(a,
b,d){var e=[],f=0,g=0;for(a=Math.abs(a);d<=b;d++)e.push(O[d]);e.sort(function(a,b){return a.height-b.height});for(d=0;d<e.length;d++)if(b=e[d],f<a)g++,f+=H[b.id].height+ca,H[b.id].textBlock.text="",H[b.id].indexLabelText="",H[b.id].isDirty=!0,H[b.id].textBlock.measureText();else break;return g}for(var d,e,f,g,h,n,k=1,r=0;r<2*k;r++){for(var l=H.length-1;0<=l&&!(0<=q(l)&&q(l),f=H[l],g=f.textBlock,n=(h=p(l)<O.length?H[p(l)]:null)?h.textBlock:null,d=+f.height.toFixed(6),e=+g.y.toFixed(6),!f.isDirty&&
(h&&e+d+ca>+n.y.toFixed(6))&&(d=g.y+d+ca-n.y,e=a(l,-d),e<d&&(0<e&&(d-=e),e=a(p(l),d),e!=d)));l--);b()}}function m(a,b){return(b<O.length?H[b].textBlock.y:u.reversed?na+D:sa+D)-(0>a?u.reversed?sa-D:na-D:H[a].textBlock.y+H[a].height+ca)}function k(a,b,c){var d,e,g,m=[],n=D,q=[];-1!==b&&(0<=Y.indexOf(b)?(e=Y.indexOf(b),Y.splice(e,1)):(Y.push(b),Y=Y.sort(function(a,b){return a-b})));if(0===Y.length)m=ha;else{e=D*(1!=Y.length||0!=Y[0]&&Y[0]!=O.length-1?2:1)/h();for(var p=0;p<O.length;p++){if(1==Y.length&&
...
b-q[d],c.y4+=b-q[d],c.y5&&(c.y5+=b-q[d],c.y6+=b-q[d]),q[d]=b}};a._animator.animate(0,c,function(c){var d=a.plotArea.ctx||a.ctx;ia=!0;d.clearRect(z.x1,z.y1,z.x2-z.x1,z.y2-z.y1);d.fillStyle=a.backgroundColor;d.fillRect(z.x1,z.y1,z.width,z.height);s.changeSection(c,b);var e={};e.dataSeries=u;e.dataPoint=u.reversed?u.dataPoints[x.length-1-b]:u.dataPoints[b];e.index=u.reversed?x.length-1-b:b;a.toolTip.highlightObjects([e]);for(e=0;e<O.length;e++)qa(d,O[e],u.fillOpacity);v(d);I&&("inside"!==u.indexLabelPlacement?
r(d):f(),l(d));1<=c&&(ia=!1)},null,M.easing.easeOutQuart)}function h(){for(var a=0,b=0;b<O.length-1;b++)(0<=Y.indexOf(b)||0<=Y.indexOf(b+1))&&a++;return a}function r(a){for(var b,c,d,e,f=0;f<O.length;f++)e=1===H[f].lineThickness%2?0.5:0,c=((O[f].y2+O[f].y4)/2<<0)+e,b=g(c).x2-1,d=H[f].textBlock.x,e=(H[f].textBlock.y+H[f].height/2<<0)+e,H[f].isDirty||0==H[f].lineThickness||(a.strokeStyle=H[f].lineColor,a.lineWidth=H[f].lineThickness,a.setLineDash&&a.setLineDash(N(H[f].lineDashType,H[f].lineThickness)),
a.beginPath(),a.moveTo(b,c),a.lineTo(d,e),a.stroke())}function q(a){for(a-=1;-1<=a&&-1!=a&&H[a].isDirty;a--);return a}function p(a){for(a+=1;a<=O.length&&a!=O.length&&H[a].isDirty;a++);return a}function g(a){for(var b,c=0;c<x.length;c++)if(O[c].y1<a&&O[c].y4>a){b=O[c];break}return b?(a=b.y6?a>b.y6?b.x3+(b.x4-b.x3)/(b.y4-b.y3)*(a-b.y3):b.x2+(b.x3-b.x2)/(b.y3-b.y2)*(a-b.y2):b.x2+(b.x3-b.x2)/(b.y3-b.y2)*(a-b.y2),{x1:a,x2:a}):-1}function l(a){for(var b=0;b<O.length;b++)H[b].isDirty||(a&&(H[b].textBlock.ctx=
a),H[b].textBlock.render(!0))}function v(a){w.plotArea.layoutManager.reset();a.roundRect||Ca(a);w.title&&(w.title.dockInsidePlotArea||"center"===w.title.horizontalAlign&&"center"===w.title.verticalAlign)&&(w.title.ctx=a,w.title.render());if(w.subtitles)for(var b=0;b<w.subtitles.length;b++){var c=w.subtitles[b];if(c.dockInsidePlotArea||"center"===c.horizontalAlign&&"center"===c.verticalAlign)w.subtitles.ctx=a,c.render()}w.legend&&(w.legend.dockInsidePlotArea||"center"===w.legend.horizontalAlign&&"center"===
w.legend.verticalAlign)&&(w.legend.ctx=a,w.legend.setLayout(),w.legend.render());J.fNg&&J.fNg(w)}var w=this;if(!(0>=a.dataSeriesIndexes.length)){for(var u=this.data[a.dataSeriesIndexes[0]],x=u.dataPoints,z=this.plotArea,D=0.025*z.width,y=0.01*z.width,B=0,E=z.height-2*D,F=Math.min(z.width-2*y,2.8*z.height),I=!1,S=0;S<x.length;S++)if(!I&&("undefined"!==typeof x[S].indexLabel&&null!==x[S].indexLabel&&0<x[S].indexLabel.toString().length)&&(I=!0),!I&&("undefined"!==typeof x[S].label&&null!==x[S].label&&
0<x[S].label.toString().length)&&(I=!0),!I&&"function"===typeof u.indexLabelFormatter||"function"===typeof x[S].indexLabelFormatter)I=!0;I=I||"undefined"!==typeof u.indexLabel&&null!==u.indexLabel&&0<u.indexLabel.toString().length;"inside"!==u.indexLabelPlacement&&I||(y=(z.width-0.75*F)/2);var S=z.x1+y,L=z.x2-y,Z=z.y1+D,R=z.y2-D,Q=a.targetCanvasCtx||this.plotArea.ctx||this.ctx;if(0!=u.length&&(u.dataPoints&&u.visible)&&0!==x.length){var P,G;a=75*F/100;var V=30*(L-a)/100;"funnel"===u.type?(P=s(u.options.neckHeight)?
0.35*E:u.neckHeight,G=s(u.options.neckWidth)?0.25*a:u.neckWidth,"string"===typeof P&&P.match(/%$/)?(P=parseInt(P),P=P*E/100):P=parseInt(P),"string"===typeof G&&G.match(/%$/)?(G=parseInt(G),G=G*a/100):G=parseInt(G),P>E?P=E:0>=P&&(P=0),G>a?G=a-0.5:0>=G&&(G=0)):"pyramid"===u.type&&(G=P=0,u.reversed=u.reversed?!1:!0);var y=S+a/2,X=S,$=S+a,na=u.reversed?R:Z,K=y-G/2,W=y+G/2,xa=u.reversed?Z+P:R-P,sa=u.reversed?Z:R;a=[];var y=[],O=[],F=[],U=Z,ba,aa=(xa-na)/(K-X),ea=-aa,S="area"===(u.valueRepresents?u.valueRepresents:
"height")?c():d();if(-1!==S){if(u.reversed)for(F.push(U),G=S.length-1;0<G;G--)U+=S[G],F.push(U);else for(G=0;G<S.length;G++)U+=S[G],F.push(U);if(u.reversed)for(G=0;G<S.length;G++)F[G]<xa?(a.push(K),y.push(W),ba=G):(a.push((F[G]-na+aa*X)/aa),y.push((F[G]-na+ea*$)/ea));else for(G=0;G<S.length;G++)F[G]<xa?(a.push((F[G]-na+aa*X)/aa),y.push((F[G]-na+ea*$)/ea),ba=G):(a.push(K),y.push(W));for(G=0;G<S.length-1;G++)U=u.reversed?x[x.length-1-G].color?x[x.length-1-G].color:u._colorSet[(x.length-1-G)%u._colorSet.length]:
x[G].color?x[G].color:u._colorSet[G%u._colorSet.length],G===ba?O.push({x1:a[G],y1:F[G],x2:y[G],y2:F[G],x3:W,y3:xa,x4:y[G+1],y4:F[G+1],x5:a[G+1],y5:F[G+1],x6:K,y6:xa,id:G,height:F[G+1]-F[G],color:U}):O.push({x1:a[G],y1:F[G],x2:y[G],y2:F[G],x3:y[G+1],y3:F[G+1],x4:a[G+1],y4:F[G+1],id:G,height:F[G+1]-F[G],color:U});var ca=2,H=[],ia=!1,Y=[],ha=[],S=!1;a=a=0;Da(Y);for(G=0;G<x.length;G++)x[G].exploded&&(S=!0,u.reversed?Y.push(x.length-1-G):Y.push(G));Q.clearRect(z.x1,z.y1,z.width,z.height);Q.fillStyle=w.backgroundColor;
Q.fillRect(z.x1,z.y1,z.width,z.height);if(I&&u.visible&&(b(),f(),e(),"inside"!==u.indexLabelPlacement)){n();for(G=0;G<x.length;G++)H[G].isDirty||(a=H[G].textBlock.x+H[G].width,a=(L-a)/2,0==G&&(B=a),B>a&&(B=a));for(G=0;G<O.length;G++)O[G].x1+=B,O[G].x2+=B,O[G].x3+=B,O[G].x4+=B,O[G].x5&&(O[G].x5+=B,O[G].x6+=B),H[G].textBlock.x+=B}for(G=0;G<O.length;G++)B=O[G],qa(Q,B,u.fillOpacity),ha.push(B.y1);v(Q);I&&u.visible&&("inside"===u.indexLabelPlacement||w.animationEnabled||r(Q),w.animationEnabled||l());if(!I)for(G=
0;G<x.length;G++)B=u.dataPointIds[G],a={id:B,objectType:"dataPoint",dataPointIndex:G,dataSeriesIndex:0,funnelSection:O[u.reversed?x.length-1-G:G]},w._eventManager.objectMap[B]=a;!w.animationEnabled&&S?k(w,-1,0):w.animationEnabled&&!w.animatedRender&&k(w,-1,0);this.funnelPyramidClickHandler=function(a){var b=-1;if(!ia&&!w.isAnimating&&(s(a.dataSeries.explodeOnClick)||a.dataSeries.explodeOnClick)&&(b=u.reversed?x.length-1-a.dataPointIndex:a.dataPointIndex,0<=b)){a=b;if("funnel"===u.type||"pyramid"===
u.type)u.reversed?x[x.length-1-a].exploded=x[x.length-1-a].exploded?!1:!0:x[a].exploded=x[a].exploded?!1:!0;k(w,b,500)}};return{source:Q,dest:this.plotArea.ctx,animationCallback:function(a,b){M.fadeInAnimation(a,b);1<=a&&(k(w,-1,500),v(w.plotArea.ctx||w.ctx))},easingFunction:M.easing.easeInQuad,animationBase:0}}}}};l.prototype.requestAnimFrame=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||
...
c.size,c.color,c.borderColor,c.borderThickness)}}};return l}();w.version="v3.0.5 Beta 1";window.CanvasJS&&(w&&!window.CanvasJS.Chart)&&(window.CanvasJS.Chart=w)})();
